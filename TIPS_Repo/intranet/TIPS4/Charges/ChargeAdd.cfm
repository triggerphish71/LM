		...
		<!--- end 25575 --->
			...
			<cfif resType neq 3> 
					...
					<cfif ChargeInfo.iChargeType_ID is not 8 OR 
						...
						<cfoutput> chargetype #ChargeInfo.iChargeType_ID#</cfoutput>
						<CFQUERY NAME = "InsertDetail" DATASOURCE = "#APPLICATION.datasource#" result="InsertDetail1">
							...
							(
								...
								getdate(),
								<!---Mshah start added for monthly charge--->
								<cfif (#ChargeInfo.iChargeType_ID# eq 1748 or #ChargeInfo.iChargeType_ID# eq 1682) and IsDefined("form.iQuantity")>
								1,
								<cfelseif IsDefined("form.iQuantity")>
								#form.iQuantity#, 
								<CFELSE> 
								#ChargeInfo.iQuantity#,
								</cfif>
								<!---Mshah--->
								...
								<!---Mshah start added for monthly charge--->
								<cfif (#ChargeInfo.iChargeType_ID# eq 1748 or #ChargeInfo.iChargeType_ID# eq 1682) and IsDefined("form.mAmount") and IsDefined("form.iQuantity")>
								#form.iQuantity*form.mAmount#,
								<cfelseif IsDefined("form.mAmount")> #form.mAmount#, 
