...
Sathya                  07/28/2010       Project 20933 Part-B added code to avoid duplication of charges
										 when the user has multiple pages opened of the same page.
--->
...
<!--- 07/28/2010 Project 20933 Part-B Sathya added this code to check duplication --->
...
<cfoutput> There is no record to update. </cfoutput>
<cfelse>
<!--- 07/28/2010 End of code for Project 20933 Part-B --->
<cftransaction>
	<cftry>
...
<!--- 07/28/2010 Project 20933 Part-B Sathya this cfif end tag --->
</cfif>
<!--- End of code --->
