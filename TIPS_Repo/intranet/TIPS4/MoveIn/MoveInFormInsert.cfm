...
|mstriegel   | 08/21/2018 | Modified query to NULL all military questions         .                 |
 ----------------------------------------------------------------------------------------------  --->
 ...
 <!---    <cfdump var="#SLevel#" label="SLevel"> --->
  ...
  <cfquery name="qrycompanionchk" datasource="#application.datasource#">   
    ...
    <cfif TenantInfo.iResidencyType_ID neq 3 and TenantInfo.iResidencyType_ID neq 2  ><!--- G --->
      ...
      <!--- mstriegel 07202018 start --->
      and ((iCharge_id = (select top 1 iCharge_id from rw.vw_Charges_history 
              where ihouse_id = #session.qSelectedHouse.iHouse_ID# and #MonthList[i]# between dtrowstart and COALESCE(dtrowend,dtEffectiveEnd,getdate())
          and iChargeType_ID = c.iChargeType_ID and iAptType_ID = c.iAptType_ID
      <!--- mstriegel 07202018 end --->
          )
          ) 
