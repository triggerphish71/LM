...
| puendia    | 03/14/2002 | Changed Find occupancy query be dependent only                     |
...
<!--- <cfoutput>
<cfdump var="#qMoveInCharges#"><br>
<cfdump var="#qMoveInChargesTotal#"><br />
qMoveInChargesTotal.totalcharges :: #qMoveInChargesTotal.totalcharges# <br />
...
tenantinfo.iMonthsDeferred :: #tenantinfo.iMonthsDeferred# <br />
</cfoutput>  
 --->
...
<cfelseif ((tenantinfo.mAdjNrf is not '') and (tenantinfo.mAdjNrf gt 0) and (tenantinfo.iMonthsDeferred gt 1))>
	<cfif qMoveInChargesTotal.totalcharges gt 0>
		<cfset totalcharges = qMoveInChargesTotal.totalcharges+ (tenantinfo.mAdjNrf/tenantinfo.iMonthsDeferred)>
	<cfelse>	
...
<cfelseif ((tenantinfo.mAdjNrf is not '') and (tenantinfo.mAdjNrf gt 0) and ((tenantinfo.iMonthsDeferred is 0) 
	...
	<cfset   totalcharges = qMoveInChargesTotal.totalcharges +tenantinfo.mAdjNrf>
...
<cfelse>
	<cfset   totalcharges = qMoveInChargesTotal.totalcharges + tenantinfo.mBaseNrf>
</cfif>
