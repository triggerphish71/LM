...
|            |            |and display page                                                    |
|MStriegel   | 10/23/2017 | Added logic for the bundled pricing                                |
 -----------------------------------------------------------------------------------------  --->
 <cfoutput>
...
<cfif session.qSelectedHouse.iHouse_ID gt 0>
 <cftry>
		...
		<cfcatch>
			...
			<cfset Formname = "MoveInFormUpdate.cfm">
			<CFSCRIPT>
				Msg1 = "There is a problem while updating the Tenant table for Charge Set.<BR>";
			</CFSCRIPT>			
...
<cfquery name="Tenant" datasource="#application.datasource#">
	...
	join TenantStateCodes tc WITH (NOLOCK) on ts.iTenantStateCode_ID = tc.iTenantStateCode_ID
...
<cfquery name="qLinkedCheck" datasource="#application.datasource#">
	select count(distinct t.itenant_id) as linkcount from Tenant T WITH (NOLOCK)
	join TenantState ts WITH (NOLOCK) on t.iTenant_ID = ts.iTenant_ID and t.dtrowdeleted is null
...
whereat = 'notyet';
	...
	CareMonthsDifference = abs(DateDiff('m',TIPSMonth,dtRent)) ;//DateDiff('m',TIPSMonth,dtMovein);	
...
<!---  <br />CareRentDaysInMonth:	
<br />Carelimit :: 

<br />MonthList :: 
<br  /> TIPsMonth:: #TIPsMonth#  <br/> --->
<cfscript>
for (i=1; i LTE Carelimit; i=i+1) {
...
<cfelse>
    ...
    Select * from aptaddress WITH (NOLOCK) where iaptaddress_ID = #trim(form.iAptAddress_ID)#
    </cfquery>
...
<cfif find('Companion',qrycompanionchk.cdescription) gt 1>
	<cfset IsCompanion = "Yes"> 
<cfelse>
	<cfset IsCompanion = "No">
</cfif>
<!---  #Tenant.iProductLine_ID#
			AND	R.iResidencyType_ID = #Tenant.iResidencyType_ID#
			AND A.iAptType_ID = #AptInfo.iAptType_id#
...
<cftry>
		<cfquery name="GetDescriptions" datasource="#application.datasource#">
			...
			FROM
				...
				,ResidencyType R
				,AptType A
			WHERE	P.iProductLine_ID = #Tenant.iProductLine_ID#
			AND	R.iResidencyType_ID = #Tenant.iResidencyType_ID#
			AND A.iAptType_ID = #qrycompanionchk.iAptType_id#
		</cfquery>
		<cfcatch>
			<cfset processname = "Resident Move In" >
			<cfset residentname = #resident#>
			...
			<cfset Formname = "MoveInFormUpdate.cfm">
			<CFSCRIPT>
				Msg1 = "There is a problem while obtaining Apartment Info.<BR>";
				Msg1 = Msg1 & "Apartment Address: #form.iAptAddress_ID#<BR>";
				Msg1 = Msg1 & "ProductLine: #Tenant.iProductLine_ID#<BR>";
				Msg1 = Msg1 & "ResidencyType: #Tenant.iResidencyType_ID#<BR>";
				Msg1 = Msg1 & "AptInfo: #qrycompanionchk.iAptType_id#<BR>";		
				Msg1 = Msg1 & "Apt. Description: #qrycompanionchk.cdescription#";
 ...
 <cfquery name="bondhouse" datasource="#application.datasource#">
	select ibondhouse, cStateCode from house WITH (NOLOCK)  where ihouse_id =  #session.qSelectedHouse.iHouse_ID#
 </cfquery>
...
<!--- 	99579		<cfif IsDefined('form.nrfADJApprove')  and (form.nrfADJApprove is not '') and (Tenant.iResidencyType_ID is not 3)	>	
		...
		<cfcatch>
			...
			<cfset Formname = "MoveInFormUpdate.cfm">
			<CFSCRIPT>
				Msg1 = "There is a problem while updating the Tenant State table.<BR>";
			</CFSCRIPT>			
			<cfset wherefrom = 'MoveIn'>
			<cflocation url="../Shared/ErrorTemplate.cfm?processname=#processname#&Formname=#Formname#&wherefrom=#wherefrom#&residentID=#residentID#&residentname=#residentname#&Msg1=#Msg1#">
		</cfcatch></cftry>	
...
<cfquery name="TenantInfo" datasource="#application.datasource#">
	...
	join tenantstate ts WITH (NOLOCK) on t.iTenant_ID = ts.iTenant_ID
	join tenantstatecodes tc WITH (NOLOCK) on ts.iTenantStateCode_ID = tc.iTenantStateCode_ID
	join aptaddress ad WITH (NOLOCK) on ts.iAptAddress_ID = ad.iAptAddress_ID
	join apttype ap WITH (NOLOCK) on ap.iAptType_ID = ad.iAptType_ID
...
<cftry>
	<cfquery name="UpdateTenantBondInfo" datasource="#application.datasource#">
		...
		<cfcatch>
			...
			<cfset Formname = "MoveInFormUpdate.cfm">
			<CFSCRIPT>
				Msg1 = "There is a problem while updating the Tenant table for Bonds Details.<BR>";
			</CFSCRIPT>			
			<cfset wherefrom = 'MoveIn'>
			<cflocation url="../Shared/ErrorTemplate.cfm?processname=#processname#&Formname=#Formname#&wherefrom=#wherefrom#&residentID=#residentID#&residentname=#residentname#&Msg1=#Msg1#">
		</cfcatch></cftry>
	...
	<cftry>
		<cfquery name="TurnRoomBond" datasource="#application.datasource#">
			...
			<cfset Formname = "MoveInFormUpdate.cfm">
			<CFSCRIPT>
				Msg1 = "There is a problem while updating the Tenant table Bond Informationt.<BR>";
			</CFSCRIPT>			
			<cfset wherefrom = 'MoveIn'>
			<cflocation url="../Shared/ErrorTemplate.cfm?processname=#processname#&Formname=#Formname#&wherefrom=#wherefrom#&residentID=#residentID#&residentname=#residentname#&Msg1=#Msg1#">
		</cfcatch></cftry>
...
<cftry>
<cfquery name="UpdateTenantPayer" datasource="#application.datasource#" result="Tenantupdate">
	update Tenant
		set cMiddleInitial = 
		...
		<cfcatch>
			...
			<cfset Formname = "MoveInFormUpdate.cfm">
			<CFSCRIPT>
				Msg1 = "There is a problem while updating for tenant payer information.<BR>";
			</CFSCRIPT>			
			<cfset wherefrom = 'MoveIn'>
			<cflocation url="../Shared/ErrorTemplate.cfm?processname=#processname#&Formname=#Formname#&wherefrom=#wherefrom#&residentID=#residentID#&residentname=#residentname#&Msg1=#Msg1#">
		</cfcatch></cftry>
...
<!---mamta testing billing type ResidentCare <cfquery name="cBillingType" datasource="#application.datasource#">
  ...
  testing cBillingType.cBillingType #cBillingType.cBillingType# --->
...
<cfquery name="GetInvoiceMasterInfo" datasource="#application.datasource#">
	...
	from Invoicemaster WITH (NOLOCK) where csolomonkey ='#Tenant.csolomonkey#'
</cfquery>
...
<cftry>	<cfquery name="deleteInvoicemasterRecord" datasource="#application.datasource#">
		...
		<cfcatch>
			...
			<cfset Formname = "MoveInFormUpdate.cfm">
			<CFSCRIPT>
				Msg1 = "There is a problem while deleting any existing Invoice Masters.<BR>";
			</CFSCRIPT>			
			<cfset wherefrom = 'MoveIn'>
			<cflocation url="../Shared/ErrorTemplate.cfm?processname=#processname#&Formname=#Formname#&wherefrom=#wherefrom#&residentID=#residentID#&residentname=#residentname#&Msg1=#Msg1#">
		</cfcatch></cftry>	
...
<cfif MoveInInvoiceCheck.RecordCount eq 0>
	...
	<cfquery name="MoveInInvoiceCheck" datasource="#application.datasource#">
		select * from InvoiceMaster im WITH (NOLOCK)
...
<cfif MoveInInvoiceCheck.iInvoiceMaster_ID neq "" and MoveInInvoiceCheck.iInvoiceMaster_ID neq 0>
	...
	=============================================================================== --->
<cftry>	<cfquery name="DeleteSystemDetails" datasource="#application.datasource#">
		...
		<cfcatch>
			...
			<cfset Formname = "MoveInFormUpdate.cfm">
			<CFSCRIPT>
				Msg1 = "There is a problem while deleting any existing Invoice Detail records.<BR>";
			</CFSCRIPT>			
			<cfset wherefrom = 'MoveIn'>
			<cflocation url="../Shared/ErrorTemplate.cfm?processname=#processname#&Formname=#Formname#&wherefrom=#wherefrom#&residentID=#residentID#&residentname=#residentname#&Msg1=#Msg1#">
		</cfcatch></cftry>	
...
<cfif MoveInInvoiceCheck.RecordCount LTE 0>
	...
	<cfquery name="GetNextInvoice" datasource="#application.datasource#">
		select iNextInvoice from HouseNumberControl WITH (NOLOCK)
		where iHouse_ID = #session.qSelectedHouse.iHouse_ID#
	</cfquery>
	...
	<cftry>
		...
		<cfcatch>
			...
			<cfset Formname = "MoveInFormUpdate.cfm">
			<CFSCRIPT>
				Msg1 = "There is a problem while creatingt New Invoice Master record.<BR>";
			</CFSCRIPT>			
			<cfset wherefrom = 'MoveIn'>
			<cflocation url="../Shared/ErrorTemplate.cfm?processname=#processname#&Formname=#Formname#&wherefrom=#wherefrom#&residentID=#residentID#&residentname=#residentname#&Msg1=#Msg1#">
		</cfcatch></cftry>
	<!--- A insert into InvoiceMaster #variables.iInvoiceNumber#<br /> --->
	<cfelse>
	<!---QUERIES  --->
		...
		<cfcatch>
			...
			<cfset Formname = "MoveInFormUpdate.cfm">
			<CFSCRIPT>
				Msg1 = "There is a problem while creating Invoice Master.<BR>";
			</CFSCRIPT>			
			<cfset wherefrom = 'MoveIn'>
			<cflocation url="../Shared/ErrorTemplate.cfm?processname=#processname#&Formname=#Formname#&wherefrom=#wherefrom#&residentID=#residentID#&residentname=#residentname#&Msg1=#Msg1#">
		</cfcatch></cftry>		
				<!--- B insert into InvoiceMaster #variables.iInvoiceNumber#<br /> --->
	...
	<cfquery name="HouseNumberControl" datasource="#application.datasource#">
		...
		where iHouse_ID = #session.qSelectedHouse.iHouse_ID#
			...
			<cfset Formname = "MoveInFormUpdate.cfm">
			<CFSCRIPT>
				Msg1 = "There is a problem while updating the HouseNumberControl table.<BR>";
			</CFSCRIPT>			
			<cfset wherefrom = 'MoveIn'>
			<cflocation url="../Shared/ErrorTemplate.cfm?processname=#processname#&Formname=#Formname#&wherefrom=#wherefrom#&residentID=#residentID#&residentname=#residentname#&Msg1=#Msg1#">
		</cfcatch></cftry>
...
<br />
 ---> 
	...
	<cfquery name="NewMasterID" datasource="#application.datasource#">
		select iInvoiceMaster_ID from InvoiceMaster WITH (NOLOCK)	where dtRowDeleted is null
...
<cfquery name="SLevel" datasource="#application.datasource#">
	...
	from 	SLevelType WITH (NOLOCK) where dtRowDeleted is null
...
<!--- 	<br /> ArrayLen(MonthList:: #ArrayLen(MonthList)#<br /> --->
...
<cfif TenantInfo.iResidencyType_ID neq 3 and  TenantInfo.iResidencyType_ID neq 2>
	...
	<cfquery name="StandardRent" datasource="#application.datasource#">
		...
		<cfif #TenantInfo.CBillingtype# eq 'D'> <!---Mshah added here winthrop--->
...
<!---  StandardRent.RecordCount :: #StandardRent.RecordCount#<br />   --->
		...
		and ((iCharge_id = (select 
							top 1 iCharge_id 
						from rw.vw_charges_history WITH (NOLOCK)
						where ihouse_id = #session.qSelectedHouse.iHouse_ID# 
		...
		<br /> StandardRent2:: #StandardRent.mamount# <br /> --->
	</cfif>
	
<!--- <br /> here:  #form.iTenant_ID# <br /> --->
...
<!---  <br />billing:: #billing#<br />  ---> 
			...
			case 'monthly':
				...
				if (TenantInfo.iResidencyType_ID neq 3 and (DaysInMonth(MonthList[i]) - 
					Day(TenantInfo.dtmovein) +1 GTE 30 
						and chargeDays[i] GTE 30 and chargeDays[i] eq DaysInMonth(MonthList[i])) )
					 {ProrateDays=0; } 
				else
					{ ProrateDays=1; }
				if(ProrateDays eq 0){
					...
					ConvertedCareAmount=((qResidentCare.mAmount/ DaysInMonth(MonthList[i]) )* (DaysInMonth(MonthList[i]) - Day(TenantInfo.dtMoveIn) +1));
					ConvertedCareChargeType=qResidentCare.iChargeType_ID;
					ConvertedCareDescription=qResidentCare.cDescription;
	...
	<!---  testConvertedDays#ConvertedDays# (#DaysInMonth(MonthList[i]) - Day(TenantInfo.dtmovein) +1#) convertedcareamountprint  #ConvertedCareAmount# ProrateDays #ProrateDays# DaysInMonth(MonthList[i]) 
	...
	<!---  test #ConvertedAmount# #ConvertedChargeType# #StandardRent.mAmount# * #(ChargeDays[i])# / #DaysInMonth(MonthList[i])#  --->
...
<!--- 	<cfelseif TenantInfo.iResidencyType_ID neq 3> --->
	<cfelse>
			...
			<CFSCRIPT>
				Msg1 = "The Daily Rate is missing for this type of Resident.<BR>";
				Msg1 = Msg1 & "Residency: #GetDescriptions.ResidencyType#<br>";
				Msg1 = Msg1 & "Apartment Type: #GetDescriptions.AptType#<BR>";
				Msg1 = Msg1 & "Occupancy: #Is2ndOccupant#<br>";
				Msg1 = Msg1 & "Product Line: #GetDescriptions.ProductLine#";
	...
	<!--- 	 
        ...
        <cfif DailyRate   less than 10.00>
          <cfset processname = "Resident Move In" >
          <cfset residentname = #resident#>
          <cfset residentID = #form.iTenant_ID#>
...
<!--- 	Old convertedAmount (House Rate) is  #ConvertedAmount#
...
<!--- 	 <br />ConvertedAmountC 1368 :: #ConvertedAmount#<br />  --->
	
	<cfif  ( #MonthList[i]#   LT  #session.TIPSMonth# )>
<!--- 		<br>ProrateRent::  #MonthList[i]#   LT  #session.TIPSMonth# <br /> --->
<cftry>
        ...
        <cfcatch type="any">
          ...
          <cfset Formname = "MoveInFormInsert.cfm">
          <CFSCRIPT>
				Msg1 = "There is a problem creating the Invoice Detail record for BSF<BR>";
			</CFSCRIPT>
          <cfset wherefrom = 'MoveIn'>
          <cflocation url="../Shared/ErrorTemplate.cfm?processname=#processname#&Formname=#Formname#&wherefrom=#wherefrom#&residentID=#residentID#&residentname=#residentname#&Msg1=#Msg1#">				  
            </cfcatch>
...
<!--- 		
				  Mamta test going in here?? tenant.iproductline_id#tenant.iproductline_id#, Tenant.cBillingType #Tenant.cBillingType# , qResidentCare.RecordCount #qResidentCare.RecordCount#
					care charges C insert into InvoiceDetail #variables.iInvoiceNumber# #ConvertedChargeType# #ConvertedAmount# RENT U1 <br /> --->
	</cfif>
<!--- 	  tenant.iproductline_id #tenant.iproductline_id# SLevel.iSPointsMin #SLevel.iSPointsMin# 
		qResidentCare.RecordCount#qResidentCare.RecordCount# Tenant.cBillingType#Tenant.cBillingType# qDailyCare.RecordCount#qDailyCare.RecordCount#  --->
	<cfif  (tenant.iproductline_id neq 2 and SLevel.iSPointsMin neq '0' and SLevel.iSPointsMax neq '0')
		...
		<!---   Mamta test going in here?? in care loop   --->
		<!--- ResidentCare  --->
...
<br />	 CareMoveInPeriod i:: #i#   :::LenCareMonthList:  #LenCareMonthList# ::LenCareMoveInPeriod:  #LenCareMoveInPeriod#  
...
<br />
  --->
		...
		<cftry>
		<cfquery name="ResidentCare" datasource="#application.datasource#" result="ResidentCare">
			insert into InvoiceDetail
        ...
        <cfcatch type="any">
          ...
          <cfset Formname = "MoveInFormInsert.cfm">
          <CFSCRIPT>
				Msg1 = "There is a problem creating the Invoice Detail for LOC record<BR>";
			</CFSCRIPT>
          <cfset wherefrom = 'MoveIn'>
          <cflocation url="../Shared/ErrorTemplate.cfm?processname=#processname#&Formname=#Formname#&wherefrom=#wherefrom#&residentID=#residentID#&residentname=#residentname#&Msg1=#Msg1#">				  
            </cfcatch>
		...
		<!--- C insert into InvoiceDetail #variables.iInvoiceNumber# #ConvertedChargeType# care U1 <br />--->
		</cfif>
		</cfif>
		</cfif>
	</cfif>
...
GetMIAutoApplyCharges: #TenantInfo.iResidencyType_ID# :: #Occupancy# :: #GetMIAutoApplyCharges.RecordCount#
 <br /> --->
				 ...
				 <br />	
					...
					<cfif ((GetMIAutoApplyCharges.iChargeType_ID neq 69) and
						...
						<!--- RECURRING PART --->
							<cfquery name="CheckforRecurringCharge" datasource="#application.datasource#">
								select * from RecurringCharge rc WITH (NOLOCK)
					...
					<!--- INVOICE PART --->
							<cfquery name="CheckforInvDtlRecord" datasource="#application.datasource#">
								select id.* from invoicedetail id WITH (NOLOCK)
						...
						<!---  E insert into InvoiceDetail #variables.iInvoiceMaster_ID# # GetMIAutoApplyCharges.iChargeType_ID# Recurring Created at MoveIn2 <br />--->
        ...
        <cfcatch type="any">
          ...
          <cfset Formname = "MoveInFormInsert.cfm">
          <CFSCRIPT>
				Msg1 = "There is a problem creating an Invoice Detail record<BR>";
			</CFSCRIPT>
          <cfset wherefrom = 'MoveIn'>
          <cflocation url="../Shared/ErrorTemplate.cfm?processname=#processname#&Formname=#Formname#&wherefrom=#wherefrom#&residentID=#residentID#&residentname=#residentname#&Msg1=#Msg1#">				  
            </cfcatch>
        </cftry>									
								</cfif>						<!---  F insert into InvoiceDetail #variables.iInvoiceMaster_ID# # GetMIAutoApplyCharges.iChargeType_ID# Recurring-Created-at-MoveIn3 <br />	--->								
							</cfif>
						</cfif>
					</cfif>
<!---               <cfquery name="BSFbase" datasource="#application.datasource#">
...
<!--- 					<cfquery name="qryCompanion" DBTYPE='QUERY'>
		...
		<cfelse>
          ...
          <cfset Formname = "MoveInFormInsert.cfm">
          <CFSCRIPT>
				Msg1 = "There is a problem creating the Community Fee/Security Deposit record<BR>";
			</CFSCRIPT>
          <cfset wherefrom = 'MoveIn'>
          <cflocation url="../Shared/ErrorTemplate.cfm?processname=#processname#&Formname=#Formname#&wherefrom=#wherefrom#&residentID=#residentID#&residentname=#residentname#&Msg1=#Msg1#">				  
            </cfcatch>
...
<cfquery name="qHouseDeposits" datasource="#application.datasource#">
	...
	join charges c WITH (NOLOCK) on (c.iChargeType_ID = ct.iChargeType_ID)
	...
	<cfloop index="Field" list="#form.fieldnames#" delimiters=",">
		<cfif FindNoCase('Deposit', Field, 1) gt 0>
			<cfquery name="qGetDepositCharge" datasource="#application.datasource#">
				select * from charges WITH (NOLOCK) where dtRowDeleted is null 
		...
		<cftry>	<cfquery name="Deposit#Evaluate('form.'& field)#" datasource="#application.datasource#">
				insert into InvoiceDetail
          ...
          <cfset Formname = "MoveInFormInsert.cfm">
          <CFSCRIPT>
				Msg1 = "There is a problem creating the Invoice Detail Deposit record<BR>";
			</CFSCRIPT>
          <cfset wherefrom = 'MoveIn'>
          <cflocation url="../Shared/ErrorTemplate.cfm?processname=#processname#&Formname=#Formname#&wherefrom=#wherefrom#&residentID=#residentID#&residentname=#residentname#&Msg1=#Msg1#">				  
            </cfcatch>
...
<cfif TenantInfo.iResidencyType_ID LT 3>
	...
	<cfquery name="qRecordCheck" datasource="#application.datasource#">
		select count(*) count from InvoiceDetail WITH (NOLOCK) where dtRowDeleted is null
...
<cfquery name="InvoiceCheck" datasource="#application.datasource#">
	...
	join TenantState ts WITH (NOLOCK) on ts.iTenant_ID = inv.iTenant_ID
...
<cfif TenantInfo.iResidencyType_ID neq 3>
	<cftry><cfquery name="qUpdateMoveInHeader" datasource="#application.datasource#">
        ...
        <cfcatch type="any">
          ...
          <cfset Formname = "MoveInFormInsert.cfm">
          <CFSCRIPT>
				Msg1 = "There is a problem Updating the Invoice Master record for totals.<BR>";
			</CFSCRIPT>
          <cfset wherefrom = 'MoveIn'>
          <cflocation url="../Shared/ErrorTemplate.cfm?processname=#processname#&Formname=#Formname#&wherefrom=#wherefrom#&residentID=#residentID#&residentname=#residentname#&Msg1=#Msg1#">				  
            </cfcatch>
...
<cfif isdefined('newNRFee') 
	...
	<cfquery name="qUpdateMoveInHeader" datasource="#application.datasource#">
        ...
        <cfcatch type="any">
          ...
          <cfset Formname = "MoveInFormInsert.cfm">
          <CFSCRIPT>
				Msg1 = "There is a problem updating teh Invoice Detail record for Communtiy Fee<BR>";
			</CFSCRIPT>
          <cfset wherefrom = 'MoveIn'>
          <cflocation url="../Shared/ErrorTemplate.cfm?processname=#processname#&Formname=#Formname#&wherefrom=#wherefrom#&residentID=#residentID#&residentname=#residentname#&Msg1=#Msg1#">				  
            </cfcatch>
...
<cfif form.cFirstName neq "" and form.cLastName neq "">
	...
	<cftry>
        ...
        <cfcatch type="any">
          ...
          <cfset Formname = "MoveInFormInsert.cfm">
          <CFSCRIPT>
				Msg1 = "There is a problem updating the Contact record<BR>";
			</CFSCRIPT>
          <cfset wherefrom = 'MoveIn'>
          <cflocation url="../Shared/ErrorTemplate.cfm?processname=#processname#&Formname=#Formname#&wherefrom=#wherefrom#&residentID=#residentID#&residentname=#residentname#&Msg1=#Msg1#">				  
            </cfcatch>
...
<!--- 				<cfif isDefined("form.oGuarentorAgreement") and form.oGuarentorAgreement eq ''>,bIsGuarantorAgreement = null
        ...
        <cfcatch type="any">
          ...
          <cfset Formname = "MoveInFormInsert.cfm">
          <CFSCRIPT>
				Msg1 = "There is a problem updating the Link Tenant Contact record<BR>";
			</CFSCRIPT>
          <cfset wherefrom = 'MoveIn'>
          <cflocation url="../Shared/ErrorTemplate.cfm?processname=#processname#&Formname=#Formname#&wherefrom=#wherefrom#&residentID=#residentID#&residentname=#residentname#&Msg1=#Msg1#">				  
            </cfcatch>
...
<cftry>
        ...
        <cfcatch type="any">
          ...
          <cfset Formname = "MoveInFormInsert.cfm">
          <CFSCRIPT>
				Msg1 = "There is a problem creating the Tenant Contact record<BR>";
			</CFSCRIPT>
          <cfset wherefrom = 'MoveIn'>
          <cflocation url="../Shared/ErrorTemplate.cfm?processname=#processname#&Formname=#Formname#&wherefrom=#wherefrom#&residentID=#residentID#&residentname=#residentname#&Msg1=#Msg1#">				  
            </cfcatch>
...
<cftry>
        ...
        <cfcatch type="any">
          ...
          <cfset Formname = "MoveInFormInsert.cfm">
          <CFSCRIPT>
				Msg1 = "There is a problem updating the TenantState Record for Primary Payer<BR>";
			</CFSCRIPT>
          <cfset wherefrom = 'MoveIn'>
          <cflocation url="../Shared/ErrorTemplate.cfm?processname=#processname#&Formname=#Formname#&wherefrom=#wherefrom#&residentID=#residentID#&residentname=#residentname#&Msg1=#Msg1#">				  
            </cfcatch>
