...
<CFQUERY NAME = "GetEmail" DATASOURCE="#APPLICATION.datasource#">
	...
	FROM House H
	LEFT OUTER JOIN	ALCWEB.dbo.employees DU	ON H.iPDUser_ID = DU.Employee_ndx
...
<CFSCRIPT>
  ...
  <!---  <cfif session.userid eq 4744>
	...
	<CFQUERY NAME = "NewTIPSMonth" DATASOURCE = "#APPLICATION.datasource#">
		SELECT dtCurrentTipsMonth FROM HouseLog WHERE dtRowDeleted IS NULL AND iHouse_ID = #ihouseid#		
	</CFQUERY>
