...
|Sfarmer/Gthota| 07/14/2014| "rw." added to the stored procedure calls                         |
|MStriegel   |11/08/2017  | set autorelease =1 and changed to call component                   |
----------------------------------------------------------------------------------------------->
...
<CFSCRIPT>
	...
	<cftry>
		...
		<cfcatch type="any">
 			...
 			<cfset housename = session.oExport2Solomon.getHouseInformation(datasource="TIPS4",houseID=iHouseID)>
	 		...
	 		<cfmail type="html" from="TIPS4-message@alcco.com" to="jgedelman@enlivant.com" cc="CFDevelopers@enlivant.com" subject="Batch not created in TiPS" mimeattach="#temp#" remove="true">
				The following house #housename# failed to close in TIPS
				<p>
				#cfcatch#<br />
			</p>
			</cfmail>				
...
<cfset argsCollection = {iHouseID=#trim(ihouseid)#,period=#dateFormat(oldtipsmonth,'yyyymm')#,invoice="",batchType="house"}>
