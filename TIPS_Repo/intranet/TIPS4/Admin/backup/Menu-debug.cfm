...
<CFIF listfindNocase(session.codeblock,25) GTE 1>
	<TABLE> 
		...
		<TR>
			...
			<TD><!---<A href="../DataTableMaintenance/InvoiceNotes/InvoiceNotes.cfm"> </A>--->  Invoice Notes Administration </TD>
		</TR>
		<TR>
...
<!--- 		<TR>
		...
		<TR>
			<TD><a href="../Tenant/TenantAREdit.cfm">Edit Move Out Dates</a></TD><!---  and Invoice Totals --->
			<TD>&nbsp;</TD>
		</TR> 		
