...
<cfabort>--->
 ...
 <!---  --->
	<cfif FileExists("#destFilePath#\EFTPullFile#todaysdate#.xls")>
		<cffile   action="rename"  source="#destFilePath#\EFTPullFile#todaysdate#.xls" destination="#destFilePath#\Old\EFTPullFile#todaysdate#.xls" >
	</cfif>
	<cfif FileExists("#destFilePath#\EFTPullFile#todaysdate#.xls")>
		<cffile action="delete"  file="#destFilePath#\EFTPullFile#todaysdate#.xls" >
	</cfif>
...
<!---   	<cfoutput>	 	
		...
		<Styles>
			...
			<Protection/>
				 ...
				 <cfset xml = ToString(xmlDataDump)> 
 			 	 <cfoutput><cffile action="append" nameconflict="overwrite" file="#destFilePath#\EFTPullFile#todaysdate#.xls"  output="#xml#"></cfoutput>  
	...
	<table>
	<tr>
		<td>EFT Pull File for Accounting Period: #thisAcctPeriod# was created in #destFilePath#\EFTPullFile#todaysdate#.xls</td>
	</tr>
	<tr>
