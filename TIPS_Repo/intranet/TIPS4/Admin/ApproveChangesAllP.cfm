...
test  --->  
<body>
<cfdocument  format="PDF"   orientation="landscape" pagewidth="11"  pageheight="8.5" margintop="1" marginbottom="1" marginleft=".5" marginright=".5">
	...
	<table width="100%">
		...
		<CFLOOP INDEX=B LIST='#rowlist#'>
			<tr>	
				...
				<td style="text-align:right;">#evaluate("cRegion_" & B)#</td>
				<td style="text-align:right;">#evaluate("House_" & B)#</td>
				<td style="text-align:right;">#evaluate("cTenantName_" & B)#</td>
				<td style="text-align:right;">#evaluate("cSolomonKey_" & B)#</td>
				<td style="text-align:right;">#evaluate("description_" & B)#</td>
				<td style="text-align:right;"> #LSCurrencyFormat(evaluate("thistotal_" & B))#</td>  
				<td style="text-align:right;">#evaluate("cappliestoacctperiod_" & B)#</td>
				<td style="text-align:right;">#evaluate("Action_" & B)#</td>
			</tr>
		</CFLOOP>
	</table>	
