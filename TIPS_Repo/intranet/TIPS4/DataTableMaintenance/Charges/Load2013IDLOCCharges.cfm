...
<cfoutput>SLevelType: #ChargeCOunt.ChargeCnt#  <br></cfoutput>
<cftransaction>
...
<!---   	<cfquery name = "ChargeInsert" datasource = "#application.datasource#">  
			...
			values  --->         
				...
				,#session.UserID# 
				,'2013JanID SFarmer Chaparelle 2013-03-01'
...
<cfoutput> done House: #thishouseID# :: #HouseName.cname# :: #count# :: Change 2 LOC ID</cfoutput>
