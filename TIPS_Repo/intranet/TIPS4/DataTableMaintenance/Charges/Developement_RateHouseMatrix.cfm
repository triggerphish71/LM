...
<!--- ==============================================================================
Retrieve all the room types for this house
=============================================================================== --->
<CFQUERY NAME="qGetRoomTypes" DATASOURCE="#APPLICATION.datasource#">
	SELECT	distinct AT.cDescription, AT.iAptType_ID
	FROM	AptAddress AD
	JOIN	AptType	AT ON (AT.iAptType_ID = AD.iAptType_ID AND AT.dtRowDeleted IS NULL)
	WHERE	AD.dtRowDeleted IS NULL
	AND		AD.iHouse_ID = 200
</CFQUERY>
...
<CFOUTPUT>
	...
	<TABLE>
		<TR>
			<CFLOOP QUERY="qGetRoomTypes"><TD>#qGetRoomTypes.cDescription#</TD></CFLOOP>
		</TR>
	</TABLE>
