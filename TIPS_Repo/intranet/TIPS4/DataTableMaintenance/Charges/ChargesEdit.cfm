...
<table style="text-align: center;">
	<tr><th>ChargeType</th><th>Description</th><th>House</th><th>Amount</th></tr>
	<tr>
	...
	<tr>
		...
		<td>
			...
			<cfelse>
				...
				/
				<input type="Text" name="YearEnd" Value = "#YearEnd#" SIZE = "3" maxlength="4" onKeyUp = "this.value=Numbers(this.value);">
		</td>
	</tr>
	<tr>
		<td colspan="2" valign="TOP">
			...
			<table style="width:100%; border:none;">				
					...
					<tr>	
						<td colspan="1">Residency Type for the house</td>
						<td colspan="1">
		...
		<td colspan = "2">
			...
			<table style="width:100%;border:none;">
				...
				<cfif ChargeType.bOccupancyPosition gt 0>
					<tr>
