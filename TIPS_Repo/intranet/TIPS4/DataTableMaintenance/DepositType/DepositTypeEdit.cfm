...
<CFQUERY NAME = "DepositTypeTable"	DATASOURCE = "#APPLICATION.datasource#">
	SELECT	DT.*, 
			CT.iChargeType_ID, CT.cGLAccount, CT.cDescription as ChargeDescription
	FROM	DEPOSITTYPE	DT
					LEFT JOIN	ChargeType CT
					ON		DT.iChargeType_ID = CT.iChargeType_ID
...
<TABLE>
	...
	<TR>		
		...
		<TD STYLE = "text-align: left;">
			<INPUT TYPE = "text" NAME = "cDescription" VALUE = "#DepositTypeTable.cDescription#" onKeyUp="this.value=Description(this.value)">
		</TD>

		<TD> Deposit Type Set		</TD>
		<TD>
			<INPUT TYPE = "text" NAME = "cDepositTypeSet" VALUE = "#DepositTypeTable.cDepositTypeSet#">
		</TD>
	</TR>
	...
	<TR>
		...
		<TD>
			<INPUT TYPE = "text" NAME = "mAmount" SIZE = "10" VALUE = "#LSCurrencyFormat(DepositTypeTable.mAmount, "none")#" STYLE = "text-align: center;">
		</TD>
		...
		<TD>
			<SELECT NAME = "iChargeType_ID">
				<OPTION VALUE = "#DepositTypeTable.iChargeType_ID#">	#DepositTypeTable.ChargeDescription# - #DepositTypeTable.cGLAccount#</OPTION>
				<CFLOOP QUERY = "ChargeTypes">
					<OPTION VALUE = "#ChargeTypes.iChargeType_ID#">	#ChargeTypes.cDescription# - #ChargeTypes.cGLAccount#</OPTION>
				</CFLOOP>
			</SELECT>
		</TD>
	</TR>
	...
	<TR>
		<TD> Display Order			</TD>
		<TD>
			<INPUT TYPE = "text" NAME = "iDisplayOrder"  SIZE = "10" VALUE = "#DepositTypeTable.iDisplayOrder#" STYLE = "text-align: center;">
		</TD>
	...
	<TR>
		<TD>	Comments							</TD>	
		<TD COLSPAN ="4">
				<TEXTAREA COLS="50" ROWS="3" NAME="cComments">#TRIM(DepositTypeTable.cComments)#</TEXTAREA>				
		</TD>
	</TR>
</CFOUTPUT>
