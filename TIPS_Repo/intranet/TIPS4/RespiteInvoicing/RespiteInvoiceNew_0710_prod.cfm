...
<!--- INFO --->
		...
		<!--- Update tenant residencyAgreement for new invocie --->
...
<cftry>
	<CFQUERY NAME="CreateRespiteInvoice" DATASOURCE="#APPLICATION.datasource#">
			EXEC sp_CreateRespiteInvoice @cSolomonKey='#URL.SolID#', @NextRRIdate='#form.NewRRIdate#', @AcctPeriod='#Period#', @NextRRIStartdate='#form.Nextdate#', @Days=#GetQuantityForNewINV.Days#, @userid=#session.userid#
	</cfquery>
