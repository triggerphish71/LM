...
<cfquery name="qResidentTenants" datasource="#application.datasource#">
	select CASE LEN(ad.cAptNumber) 
			...
			,ts.dtMoveIn ,ts.dtMoveOut ,ts.iSPoints ,st.cDescription as Level ,ts.iproductline_id, ts.bNRFPend 
	...
	group by
			...
			,ts.dtMoveIn ,ts.dtMoveOut ,ts.iSPoints ,st.cDescription ,ts.iproductline_id
			,pl.iproductline_id
			,AD.bIsBond
			,TPS.cDescription
...
<table>
	...
	<th><a href="?SelectedSortOrder=MoveIn" style="color: White;" onMouseOver="hoverdesc('Sort by Move In date');" onMouseOut="resetdesc();"> MoveIn </a> </th>
	...
	<cfoutput query="MovedOut">
		...
		<cf_cttr colorOne="E6E6FA" colorTwo="E6E6F0">
			...
			<td> <a href="MoveIn/MoveInReport.cfm?ID=#MovedOut.iTenant_ID#"> #DATEFORMAT(MovedOut.dtMoveIn, "mm/dd/yyyy")# </a> </td>
