		...
		<cfdocumentitem type="header"  evalAtPrint="true">
			<cfoutput>
				<table width="100%">
					<tr>
						<td align="center">
							<h1 style="text-align:center; text-decoration:underline;">#HouseData.cname#<br />Daily Census Report<br />Date: #dateformat(dtcompare,'mmmm dd, yyyy')#</h1>
						</td>
					</tr>			
				</table>
				</cfoutput>
			...
			<tr>
				...
				<td valign="bottom"  style="border: 2px solid black; text-align: center; font-weight:bold;">Payor Type</td>
				<td valign="bottom"  style="border: 2px solid black; text-align: center; font-weight:bold;" >
					Previous<br /> 
					Day<br /> 
					Status <br />
