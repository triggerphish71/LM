...
|----------------------------------------------------------------------------------------------|
| HISTORY                                                                                      |
| Called by ValidateDailyCensus_RL.cfm															   |     
| Calls TrackTenantStatus_RL.cfm                                                                  |
|----------------------------------------------------------------------------------------------|
| Author     | Date       | Description                                                        |
|------------|------------|--------------------------------------------------------------------|
| gthota     | 09/06/2017 | Created initial page for resident census update                    | 
----------------------------------------------------------------------------------------------->
...
<body >
	...
	<form name="tenantstatus" id="tenantstatus" action="TrackTenantStatus_RL.cfm" method="post" >
