<SCRIPT> report=window.open("loading.htm","AssessmentUpdate","toolbar=no,resizable=yes"); report.moveTo(0,0); </SCRIPT>
...
<CFOUTPUT>
		<FORM NAME="AssessmentUpdate" ACTION="//#crserver#/reports/tips/tips4/AssessmentUpdate.rpt" METHOD="Post" TARGET="AssessmentUpdate" onSubmit="opennew();">
		...
		<SCRIPT> location.href='#HTTP_REFERER#'; document.AssessmentUpdate.submit(); </SCRIPT>
	</FORM>
