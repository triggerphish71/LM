...
<CFOUTPUT>
	<CFIF isDefined("SESSION.UserID") AND SESSION.UserID IS 3025><CFIF IsDefined("form.fieldnames")>#form.fieldnames#<BR>#form.prompt0#<BR>#form.prompt2#<BR></CFIF></CFIF>
	<CENTER><B STYLE="font-size: 30;">Please, wait while the report is loading....</B></CENTER>
</CFOUTPUT>

<SCRIPT>report=window.open("loading.htm","InvalidSSNReport","toolbar=no,resizable=yes");report.moveTo(0,0);</SCRIPT>
...
=============================================================================== --->
		...
		<form action="//#crserver#/reports/tips/tips4/invalidssn.rpt" method="POST" name="Validation" TARGET="InvalidSSNReport">
			...
			<input type=hidden name="prompt1" value="#HouseData.cNumber#">
			<SCRIPT> location.href='#HTTP_REFERER#'; document.Validation.submit(); </SCRIPT>
