...
04/26/2017  | gthota    |         | corrected multiple periods of invoices                    |
 --->	
...
<!---
<cfloop query = 'sp_Invoices_report'>
#sp_Invoices_report.dtInvoiceEnd#</cfloop>
 --->
 ...
 <!--- <cfdump var="#qryTransactions#"> <cfabort> --->
</CFOUTPUT>
...
<table  width="95%" style="border-bottom:thin">
	...
	<tr>
		<td style="font-size:12px;">#iInvoicenumber#/#detailappliestoacctPeriod#</td>
		<td style="font-size:12px;">
