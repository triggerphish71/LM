...
|S Farmer    | 01/07/2015 | corrected qResident when there is more than 1 contact payor         |
|sfarmer     | 2017-05-09 | 'move out date' changed to 'physical move out date'                 |
 --->
	...
	<cfquery name="qResident" datasource="#application.datasource#">
		Select  top 1  t.cfirstname  + ' ' + t.clastname Name , t.csolomonkey, ts.ispoints, ts.iResidencyType_ID
		...
		cont.cfirstname + ' ' + cont.clastname as 'ContactName', cont.cAddressLine1 as ContactAddr1 , cont.cAddressLine2 as ContactAddr2
		, cont.cCity as ContactCity, cont.cStateCode as ContactState, cont.cZipCode as ContactZipcode, cont.cphonenumber1 as COntactPhone
		 from tenant t 
		...
		left join contact cont on ltc.icontact_id = cont.icontact_id
		 ...
		 order by    ltc.bIsGuarantorAgreement  
	</cfquery> 		
...
<!--- 		EXEC rw.sp_ActivityLog_Detail
			...
			<cfquery name="HouseDetail" datasource="#application.datasource#">
				select cname HouseName, caddressline1, caddressline2, ccity,  cstatecode, czipcode, cphonenumber1 
			...
			<body>
				...
				<table width="95%"  cellspacing="2" cellpadding="2" > 
					<cfoutput query="qResident">
						...
						<tr> 
							<div>
								<td   style="text-align:left">Financial Possession Date:</td> 							
								<td   style="text-align:left">#dateformat(dtrenteffective, "mm/dd/yyyy")#</td> 
								<td  >&nbsp;</td> 							
								<td   style="text-align:left">Residency Type:</td> 
								<td   style="text-align:left">#restype#</td> 							
							</div>
						</tr> 
						<tr> 
							<div>
								<td   style="text-align:left">Physical Move-In Date:</td> 							
								<td   style="text-align:left">#dateformat(dtmovein, "mm/dd/yyyy")#</td> 
								<td  >&nbsp;</td> 							
								<td   style="text-align:left">Service Points:</td> 
								<td   style="text-align:left">#ispoints#</td> 							
							</div>
						</tr>  
						...
						<tr> 
							<div>
								...
								<td   style="text-align:left">#dateformat(dtMoveOutProjectedDate, "mm/dd/yyyy")#</td> 
								<td  >&nbsp;</td> 							
					...
					<table width="95%"  cellspacing="2" cellpadding="2" >
 						<tr> 
							<div>
							<td colspan="6" style="text-align:left; font-size:20px; font-weight:bold ">&nbsp;</td> 
							</div>
						</tr>						
 						<tr> 
							<div>
							<td colspan="6" style="text-align:left; font-size:20px; font-weight:bold ">Summary of Charges:</td> 
							</div>
						</tr> 					
 					<cfoutput query="MoveInInvoice" group="Feetype" >
						<cfif Feetype is "1MonthlyFee">
							<tr>
								<div>
									<td ><div>&nbsp;</div></td>
									<td style="text-decoration:underline;text-align:center; font-weight:bold"><div>Start Date</div></td>
									<td style="text-decoration:underline;text-align:center; font-weight:bold"><div>End Date</div></td>
									<Td style="text-decoration:underline;text-align:center; font-weight:bold"><div>Days Charged</div></Td>
									<td style="text-decoration:underline;text-align:center; font-weight:bold"><div>Rate</div></td>
									<td style="text-decoration:underline;text-align:center; font-weight:bold"><div>Total</div></td>
								</div>
							</tr>						
							<tr>
								<div>
									...
									<td style="text-align:center; font-weight:bold"><div>&nbsp;</div></td>
									<td style="text-align:center; font-weight:bold"><div>&nbsp;</div></td>
									<Td style="text-align:center; font-weight:bold"><div>&nbsp;</div></Td>
									<td style="text-align:center; font-weight:bold"><div>&nbsp;</div></td>
									<td style="text-align:center; font-weight:bold"><div>&nbsp;</div></td>
						...
						<cfoutput >
							...
							<tr><div>
								...
								<td  style="text-align:center">
										...
										<cfelse>
											<cfset monthstart =  left(acctperiod,4) & '-' & right(acctperiod,2) & '-' & '01'>
											#dateformat(monthstart, 'mm/dd/yyyy')#
										</cfif>
								</td>
								<cfelse>
									<td  style="text-align:center">
										<cfif datepart("m",qResident.dtRentEffective)is right(acctperiod,2)>
...
<!--- 								<cfelse>
								...
								<div>
								<td   style="text-align:right" >#dollarformat(mamount *iquantity )#</td>
								</div>			
							</tr>
							...
							<tr>
								...
								<td style="text-decoration:overline; text-align:right;">#dollarformat(MSFsubtotal)#</td> 
							</tr>						
						<cfelseif   Feetype is "2AncillaryFee">
							<tr>
								<div>
									<td><div>&nbsp;</div></td>
									<td><div>&nbsp;</div></td>
								 	<td style="text-decoration:underline;text-align:center; font-weight:bold">
										<div>End Date</div></td>
									<Td  colspan="1" style="text-decoration:underline;text-align:right; font-weight:bold">
						...
						<cfoutput>				
							...
							<tr>
								<td colspan="4">&nbsp;</td>
								<td style="font-style:italic; text-align:center;">Subtotal</td>
								<td style="text-decoration:overline;text-align:right; " >#dollarformat(ancillarysubtotal)#</td> 
							</tr>		 
						<cfelseif   Feetype is "3OneTimeFee">
 						<tr> 
							...
							<tr>
								<div>
								<td style=" font-style:italic; text-align:center; font-weight:bold"><div>One Time Fees</div></td>
							...
							<cfoutput>			
							<tr><div>
								<td ><cfif cdescription is 'New Resident Fee'> Community Fee<cfelse>#cdescription#</cfif></td>
								</div>
								<div>
								<td >&nbsp;</td>
								</div>
					...
					<cfoutput>
							<tr>
								...
								<td style="font-weight:bold; text-align:right; text-decoration:underline; text-decoration:overline" >
...
<cfsavecontent variable="PDFhtml2">
				...
				<table>
					<tr>
						<td style="text-align:left; text-decoration:underline; font-weight:bold">Confirmation of Payer Information </td>
					</tr>
					<cfif qResident.tenantpayer is 1>
						<tr>
							<td>#qResident.Name#</td>
						</tr>
						<tr>
							<td>#HouseDetail.caddressline1# Apt. #qResident.captnumber#</td>
						</tr>
						...
						<tr>
							<td>#HouseDetail.ccity#, #HouseDetail.cstatecode# #HouseDetail.czipcode#</td>
						</tr>
						<tr>
					...
					<cfelse>
						<tr>
							<td>#qResident.ContactName#</td>
						</tr>
						<tr>
							<td>#qResident.ContactAddr1#</td>
						</tr>
						<cfif qResident.ContactAddr2 is not ''>
							<tr>
								<td>#qResident.ContactAddr2#</td>
							</tr>
						</cfif>
						<tr>
							<td>#qResident.ContactCity#, #qResident.contactstate# #qResident.contactzipcode#</td>
						</tr>
						<tr>
							<td>(#left(qResident.ContactPhone,3)#) #mid(qResident.ContactPhone,4,3)#-#right(qResident.ContactPhone,4)#</td>
						</tr>					
					</cfif>					
				</table>
				</cfoutput>
...
<cfdocument format="PDF" orientation="portrait" margintop="1" >	
	<cfdocumentitem type="header">
		<div  style="text-align:center; height:350px"><img src="../../images/Enlivant_logo.jpg"  height="333"  width="500" /></div>
	</cfdocumentitem>
	<cfoutput>
		#variables.PDFhtml#
