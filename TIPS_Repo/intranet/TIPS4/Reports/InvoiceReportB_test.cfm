...
01/26/2016  | S Farmer    |         | corrected qryTransactions for end date                  |
 --->	
	...
	<cfparam name="bUsesEFT" default="">
  	<cfif prompt0 is 'All'>
	<cflocation url="InvoiceReportC_test.cfm?prompt0=#prompt0#&prompt1=#prompt1#&prompt2=#prompt2#&prompt3=#prompt3#&prompt4=#prompt4#&bUsesEFT=#bUsesEFT#">
	</cfif>
...
<cfelse>
	...
	<cfquery name="qryTransactions" datasource="#application.datasource#">
		...
		FROM     Shaggy.Houses_APP.dbo.vw_tips_GetTran   vw_tips_GetTran (NOLOCK)
