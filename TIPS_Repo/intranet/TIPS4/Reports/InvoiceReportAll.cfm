	...
	<cfif SelectAll.recordcount lt 1>
		<cfoutput>
			...
			<div>
				...
				<h3>No Invoice was found for #SelectAll.Residentname# (Resident ID #prompt0#) for period #prompt2#</h3>
				<br /><br /><a href="Menu.cfm">Return to Reports Menu</a>
			</div>
		</cfoutput>
		<cfabort>
	</cfif>
<cfset createDirectory = "\\fs01\ALC_IT\Invoices\#HouseData.cname#\">
<cfif DirectoryExists(createDirectory)>
<cfoutput><!--- Directory #createDirectory# created ---><br /></cfoutput>
<cfelse>
         <cftry> 
...
<body> 
		...
		<cfdocument  format="PDF" orientation="portrait" margintop="1" marginbottom="1" 
		 filename="#createDirectory#\InvoiceReport-#qryTenant.Residentname#-#prompt2#.pdf" overwrite="yes">	
...
<cfoutput>
<Div>
<h2> #count# Invoices writen to #createDirectory# <br />

 <a href="InvoiceViewFile.cfm">View Invoices</a> <br /> 
<a href="Menu.cfm">Return to Reports Menu</a><br />
</h2>
</Div>
</cfoutput>
