...
| gthota     | 10/30/2012 | added javascript for base level to check the points & level        |
----------------------------------------------------------------------------------------------->
...
<script language="JavaScript" type="text/javascript">
	function statusvalidation(formCheck)
	{
		...
		if(reviewDateCheck > todayDate)
		{
		 ...
		 if((document.getElementById('baseno').value == "yes" && document.getElementById('baseno').checked == true) && (totalPoints > 0))
		   {
