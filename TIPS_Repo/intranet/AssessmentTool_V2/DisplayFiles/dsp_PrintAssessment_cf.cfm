...
<head>
   ...
   <!---    <cfquery name="sp_assessmenttoolsummary" datasource="#application.datasource#">
	...
	<cfoutput  >
		<div>
				<table width="50%" style="float: left; margintop:0px;"> 
					<tr> 
				...
				<table width="50%"  cellspacing="2" cellpadding="2" style="float: right; margintop:0;">
					<tr>
					<td  width="25%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:14px" >
				   ...
				   <td width="25%">&nbsp;
					...
					<tr>
					<td style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:14px; border-bottom:1px solid black; margintop:0;">
		    	<b>Points System :</b> <br> Assessment Tool #sp_assessmenttoolsummary.iAssessmentTool_id# </td> 
					</tr>
					<cfloop query="sp_PointsList">	
					<td   style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:14px ">
			        level #sp_PointsList.cdescription# : #sp_PointsList.ispointsmin#-#sp_PointsList.iSPointsMax# </td> 
					</tr>	
					</cfloop>
				</table>
	</div>
		       ...
		       <tr> 
					...
					#selectservicecategory.cdescription#
						...
						<cfloop query="assessmentoolsummaryservicecategorynotes">
							 <cfif #assessmentoolsummaryservicecategorynotes.ctruncatednotes# neq "">
								 <tr>  <td style="text-align:left; font-family: Arial, Helvetica, sans-serif; font-size:14px; font-weight:normal;margin-left:2em">
				...
				<cfloop query="AssessmentToolSummaryservicelevel">
					<cfif service_level NEQ #AssessmentToolSummaryservicelevel.cTruncatedDescription#>
						...
						<tr>					     
					      <td style="text-align:left; font-family: Arial, Helvetica, sans-serif; font-size:14px; font-weight:normal;margin-left:2em">
							...
							<cfif notes neq #Assessmenttoolsummarycnotes.ctruncatednotes#>
						       	<cfset notes = #Assessmenttoolsummarycnotes.ctruncatednotes#>
						       		<cfif  #Assessmenttoolsummarycnotes.ctruncatednotes# NEQ "">
							 			<tr>
				                 			<td style="text-align:left; font-family: Arial, Helvetica, sans-serif; font-size:14px; margin-left:2em">
					    	 ...
					    	 <cfif #Assessmenttoolsummarycnotes2.isubservicelist_ID# NEQ ''>
						     	<cfquery name="Assessmenttoolsummarysubdescription" dbtype="query">
		                      	...
		                      	<cfloop query="Assessmenttoolsummarysubdescription">
			                    	<tr>
							         	<td style="text-align:left; font-family: Arial, Helvetica, sans-serif; font-size:14px; font-weight:normal;margin-left:5em" >
  ...
  <cfsavecontent variable="PDFhtml2">
	<cfoutput>
			...
			<table width="75%"  cellspacing="2" cellpadding="2" style="float: left;">
					<tr> 
					   <td width="25%" style="text-align:left; font-family: Arial, Helvetica, sans-serif; font-size:14px;">
						...
						<td width="80%" style="text-align:left; font-family: Arial, Helvetica, sans-serif; font-size:14px">
			        ...
			        <tr> 
					   <td width="20%" style="text-align:left; font-family: Arial, Helvetica, sans-serif; font-size:14px">
							<b>Sixth Diagnosis : </b>
						</td>
						<td width="80%" style="text-align:left; font-family: Arial, Helvetica, sans-serif; font-size:14px">
		...
		<table width="25%"  cellspacing="2" cellpadding="2" style="float: right;">
					<tr> 
					   <td style="text-align:right; font-family: Arial, Helvetica, sans-serif; font-size:14px">
	...
	<table  width="95%"  cellspacing="2" cellpadding="2">
				    <tr> 
					   <td  width="20%" style="text-align:left; font-family: Arial, Helvetica, sans-serif; font-size:14px; vertical-align:top">
							<b>Diagnosis </b></td> 
						<td width="80%" style="text-align:left; font-family: Arial, Helvetica, sans-serif; font-size:14px"> #REReplace(sp_assessmenttoolsummary.tDiagnosis, Chr(10), "<br>", "ALL")#</td>
					</tr> 
					<tr> 
						<td width="20%" style="text-align:left; font-family: Arial, Helvetica, sans-serif; font-size:14px;vertical-align:top">
							<b>Other Services </b> </td>
						<td width="80%" style="text-align:left; font-family: Arial, Helvetica, sans-serif; font-size:14px"> #REReplace(sp_assessmenttoolsummary.tOtherservices, Chr(10), "<br>", "ALL")#</td> 
					</tr> 
					<tr> 
					   <td width="20%" style="text-align:left; font-family: Arial, Helvetica, sans-serif; font-size:14px; vertical-align:top">
							<b>Allergis </b> </td>
					  <td width="80%" style="text-align:left; font-family: Arial, Helvetica, sans-serif; font-size:14px">#REReplace(sp_assessmenttoolsummary.tallergies, Chr(10), "<br>", "ALL")#</td> 
					</tr> 
					
		</table>			
	</div>
	
	<div style="bottom:0px; position:bottom;" >
    	<table width="95%"  cellspacing="2" >	
		          
				  <tr><td>&nbsp;</td></tr>
				  <tr><td>&nbsp;</td></tr>
				  <tr> 
					<td style="text-align:centre; font-family: Arial, Helvetica, sans-serif; font-size:14px; ">
					 ...
					 <tr>
					   <td  style="text-align:left; font-family: Arial, Helvetica, sans-serif; font-size:14px; border-bottom:1px solid black;">
						&nbsp; <br>&nbsp;</br> <br>&nbsp;</br> </td> 
					...
					<table width="95%"  cellspacing="2">	
					<tr>
					   <td width="50%" style="text-align:left; font-family: Arial, Helvetica, sans-serif; font-size:14px; border-bottom:1px solid black;">&nbsp;
						  </td>
						 <td width="50%" style="text-align:left; font-family: Arial, Helvetica, sans-serif; font-size:14px; border-bottom:1px solid black;">&nbsp;
						  </td>  
					</tr> 
					<tr>
					   <td width="50%" style="text-align:left; font-family: Arial, Helvetica, sans-serif; font-size:14px">
...
<cfoutput>
    ...
    <cfdocumentitem  type="footer" evalAtPrint="true">
		<cfoutput>
			...
			<br/>Printed #DATEFORMAT(now(), "mm/dd/yyyy")# #TimeFormat(Now())#
