...
<!---    <cfquery name="sp_assessmenttoolsummary" datasource="#application.datasource#">
			EXEC rw.sp_assessmenttoolsummary
				...
				,@summary='N'
				,@Scope=''
		</cfquery> 	---><!--- Ganga Thota 08/01/2017 commented this bcz when user try to save/update pdf getting error --->
		<cfquery name="sp_assessmenttoolsummary" datasource="#application.datasource#">
...
<!--- Gthota - 02/24/2018 added to get care level rates --->
		
  	   <cfquery name="getTenantset" datasource="#application.datasource#">
			select cchargeset from Tenant with (NOLOCK)			
			where iTenant_ID = #sp_assessmenttoolsummary.iTenant_id#
		</cfquery>
		 <cfquery name="getcarerates" datasource="#application.datasource#">
				Select * 
				from Charges with (NOLOCK)
				where ihouse_id = #session.qselectedhouse.ihouse_ID#
				and iChargeType_ID = 91 and dtrowdeleted is null
				And cChargeset = '#getTenantset.cchargeset#'
				and cDescription < 'Resident Care - Level 6 + 1 points'
				<!--- or cDescription in ('Resident Care - Level 6 + 1 points','Resident Care - Level 6 + 2 points')) --->
				order by cChargeSet desc , CONVERT(varchar, cDescription)
			</cfquery>	
		...
		<div>
				...
				<table width="50%"  cellspacing="2" cellpadding="2" style="float: right;">
		    	   ...
		    	   <b> Daily Service Level Rates </b>
					...
					<td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px; border-bottom:1px solid black;">
					   &nbsp;
				   </td>
					</tr>
				<cfset cnt = 0>
				 <cfloop index="lvl" from="1" to="#getcarerates.recordcount#">						
					<cfif cnt gt 0>
					<cfelse>
					<tr> 
					   <td width="25%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> 1-9 points  </td>
					   <td width="25%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> Lvl 1=#NumberFormat(getcarerates['mamount'][val(1)], "0.00" )#</td>
					</tr>
					<tr> 
					   <td width="25%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> 10-19 points  </td>
					   <td width="25%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> Lvl 2=#NumberFormat(getcarerates['mamount'][val(2)], "0.00" )#</td>
					</tr>	
					<tr> 
					   <td width="25%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> 20-29 points  </td>
					   <td width="25%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> Lvl 3=#NumberFormat(getcarerates['mamount'][val(3)], "0.00" )#</td>
					</tr>
					<tr> 
					   <td width="25%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> 30-39 points  </td>
					   <td width="25%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> Lvl 4=#NumberFormat(getcarerates['mamount'][val(4)], "0.00" )#</td>
					</tr>	
					<tr> 
					   <td width="25%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> 40-49 points  </td>
					   <td width="25%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> Lvl 5=#NumberFormat(getcarerates['mamount'][val(5)], "0.00" )#</td>
					</tr>
					<tr> 
					   <td width="25%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> 50-59 points  </td>
					   <td width="25%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> Lvl 6=#NumberFormat(getcarerates['mamount'][val(6)], "0.00" )#</td>
					</tr>	
					<tr> 
					   <td width="25%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> 60 points and above  </td>
					   <td width="25%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> Lvl 6+ (2.10 a pt)</td>
					</tr>
					</cfif>
					<cfset cnt = cnt+1>
				  </cfloop>		
					    ...
					    <cfloop query="Assessmenttoolsummarycnotes2"> 	
					    	 <cfif #Assessmenttoolsummarycnotes2.isubservicelist_ID# NEQ ''>
						     	<cfquery name="Assessmenttoolsummarysubdescription" dbtype="query">
							       Select distinct truncatedsubdescription,fsubweight,iselectedservice,csubSortOrder from sp_AssessmentToolSummary
		                           where isubservicelist_ID= #Assessmenttoolsummarycnotes2.isubservicelist_ID#
								   order by csubSortOrder asc
		                      	</cfquery>
 ...
 <cfsavecontent variable="PDFhtml2">  
	...
	<div style="margin-left:2em;">
		<table width="40%" style="float: left; border:solid gray;1px;width:thin;">
			 ...
			 <tr>
				<td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px; border-bottom:1px solid gray;">
		    	    <b>Daily Service Level Rates</b>
					</td>
				<cfset cnt = 0>
				<cfloop index="lvl" from="1" to="#getcarerates.recordcount#">						
				...
				<cfelse>
					...
					<tr> 
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> 1-9 points  </td>
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> Lvl 1=#NumberFormat(getcarerates['mamount'][val(1)], "0.00" )#</td>
					</tr>
					<tr> 
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> 10-19 points  </td>
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> Lvl 2=#NumberFormat(getcarerates['mamount'][val(2)], "0.00" )#</td>
					</tr>	
					<tr> 
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> 20-29 points  </td>
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> Lvl 3=#NumberFormat(getcarerates['mamount'][val(3)], "0.00" )#</td>
					</tr>
					<tr> 
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> 30-39 points  </td>
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> Lvl 4=#NumberFormat(getcarerates['mamount'][val(4)], "0.00" )#</td>
					</tr>	
					<tr> 
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> 40-49 points  </td>
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> Lvl 5=#NumberFormat(getcarerates['mamount'][val(5)], "0.00" )#</td>
					</tr>
					<tr> 
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> 50-59 points  </td>
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> Lvl 6=#NumberFormat(getcarerates['mamount'][val(6)], "0.00" )#</td>
					</tr>	
					<tr> 
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> 60 points and above  </td>
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> Lvl 6+ (2.10 a pt)</td>
					</tr>
				</cfif>
				<cfset cnt = cnt+1>
				</cfloop>			
		...
		<table width="40%" style="float: right; margin-right:5em;  border: 1px solid gray; border-spacing: 0px; border-collapse: collapse;" cellspacing="0" cellpadding="0">
			 <tr>
				<td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px; border: 1px solid gray; border-spacing: 0px; border-collapse: collapse">
		    	   Add Pages Total to determine Total points
					...
					<tr> 
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px; border: 1px solid gray; border-spacing: 0px; border-collapse: collapse; "> Page 1 points  </td>
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px; border: 1px solid gray; border-spacing: 0px; border-collapse: collapse;"> </td>
					</tr>
					<tr> 
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px; border: 1px solid gray; border-spacing: 0px; border-collapse: collapse;"> Page 2 points  </td>
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px; border: 1px solid gray; border-spacing: 0px; border-collapse: collapse;"> </td>
					</tr>	
					<tr> 
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px; border: 1px solid gray; border-spacing: 0px; border-collapse: collapse;"> Page 3 points  </td>
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px; border: 1px solid gray; border-spacing: 0px; border-collapse: collapse;"> </td>
					</tr>
					<tr> 
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px; border: 1px solid gray; border-spacing: 0px; border-collapse: collapse;"> Page 4 points  </td>
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px; border: 1px solid gray; border-spacing: 0px; border-collapse: collapse;"> </td>
					</tr>	
					<tr> 
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px; border: 1px solid gray; border-spacing: 0px; border-collapse: collapse;"> Page 5 points  </td>
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px; border: 1px solid gray; border-spacing: 0px; border-collapse: collapse;"> </td>
					</tr>
					<tr> 
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px; border: 1px solid gray; border-spacing: 0px; border-collapse: collapse;"> Page 6 points  </td>
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px; border: 1px solid gray; border-spacing: 0px; border-collapse: collapse"> </td>
					</tr>	
					<tr> 
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px; border: 1px solid gray; border-spacing: 0px; border-collapse: collapse;"> Page 7 points </td>
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px; border: 1px solid gray; border-spacing: 0px; border-collapse: collapse;"> </td>
					</tr>
					<tr> 
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px; border: 1px solid gray; border-spacing: 0px; border-collapse: collapse;">Total points </td>
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px; border: 1px solid gray; border-spacing: 0px; border-collapse: collapse;"> </td>
					</tr>	
				</table>
	</div>
