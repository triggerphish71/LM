...
<cfquery name="gethouseset" datasource="#application.datasource#">
			select cs.cdescription from House h
			join ChargeSet cs on h.iChargeSet_ID = cs.iChargeSet_ID and cs.dtRowDeleted is null
		 ...
		 <cfquery name="getcarerates" datasource="#application.datasource#">
				...
				And cChargeset = <cfif getTenantset.cchargeset GT ''>'#getTenantset.cchargeset#'<cfelse>'#gethouseset.cdescription#'</cfif>
