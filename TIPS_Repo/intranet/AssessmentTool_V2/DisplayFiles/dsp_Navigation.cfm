...
<table class="navigation" cellspacing="1" cellpadding="3" id="menu" name="menu">
	<tr>
		...
		<td class="navigation" onmouseover="this.className='navigationOver';this.childNodes[0].className='navigationOver'" onmouseout="this.className='navigation'" onclick="window.location='http://#cgi.server_name#/intranet/tips4/Registration/Registration.cfm?selectedhouse_id=#session.house.getid()#'">
			Inquiry/MoveIn
		</td>
...
<!---<div class="administrationLink"><a href="index.cfm?fuse=reports" class="header">Assessment Tool Reports</a></div>--->
...
<br>
<cfset number_house = #session.house.getid()#>
<table><tr><b style="color:##CC00CC"><font size="2"> **If you experiencing any problems. Please take a look ‘New Assessment Help’ link before calling Help Desk.
</font></b>
<td align="left">
<div class="administrationLink"><a href="../AssessmentTool_V2/DisplayFiles/New Assessment Help.pdf" class="header" target="_blank"><b style="color:##CC00CC"><font size="2"> New Assessment Help </font></b></a></div>
<cfif number_house eq 25 OR number_house eq 32 OR number_house eq 43 OR number_house eq 66 OR number_house eq 166 OR number_house eq 164 OR number_house eq 174> 
  <div class="administrationLink"><a href="../AssessmentTool_V2/DisplayFiles/ALC_BlankAssessment_2013_ID.pdf" class="header" target="_blank">Print Blank Assessment 2013</a></div>
<cfelse>
  <div class="administrationLink"><a href="../AssessmentTool_V2/DisplayFiles/ALC_BlankAssessment_2012_Form.pdf" class="header" target="_blank">Print Blank Assessment 2012</a></div>
</cfif>
<!---<div class="administrationLink"><a href="../AssessmentTool_V2/DisplayFiles/ALC_BlankAssessment_2012_Form.pdf" class="header" target="_blank">Print Blank Assessment 2012</a></div>--->
</td></tr></table>
</cfoutput>