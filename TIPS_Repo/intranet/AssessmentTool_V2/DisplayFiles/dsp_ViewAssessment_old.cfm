...
| S Farmer   | 09/19/2011 | Allow for all document types to be printed.     Project 12352      |
|            |            |                                                                    |
----------------------------------------------------------------------------------------------->
<cfparam name="Reviewdescription" default="">
<cfoutput>
...
<table width="800">
	...
	<cfif Reviewdescription is "Change"><a onclick="show_calendar2('document.forms[0].nextReviewDate',document.getElementsByName('nextReviewDate')[0].value);"> <img src="../global/Calendar/calendar.gif" alt="Calendar" width="16" height="15" border="0" align="middle" style="border: 3px solid ##ccccff;"> </a></cfif>
					</td>
				</tr>
				...
				<!--- <cfelseif IsDefined("Assessment") AND Assessment.GetIsBillingActive() > ---> <!--- s Farmer 12352 --->
				<tr>
					<td class="assessmentHeader">Print</td>
					<td>
						<cfif #Assessment.GetResidentID()# eq 0>
						<a href="index.cfm?fuse=printAssessment&assessmentId=#assessment.GetId()#&type=fromstar" class="breadcrumbs" target="_blank">Print</a>
						<cfelse>
						<a href="index.cfm?fuse=printAssessment&assessmentId=#assessment.GetId()#&type=fromtips" class="breadcrumbs" target="_blank">Print</a>
						</cfif>						
					</td>
				</tr>
				<!--- </cfif> ---> <!--- s Farmer 12352 --->
