...
<!---<cfif HouseData.iHouse_ID eq 17 or HouseData.iHouse_ID eq 16>
<form name="AssessmentSummary" ACTION="//#crserver#/reports/tips/tips4/AssessmentToolSummary_New-v3.rpt" method="Post" target="AssessmentReport">
<cfelse>
...
<form name="AssessmentSummary" ACTION="//#crserver#/reports/tips/tips4/AssessmentToolPrintSummary_Enquiry_11.rpt" method="Post" target="AssessmentReport">
