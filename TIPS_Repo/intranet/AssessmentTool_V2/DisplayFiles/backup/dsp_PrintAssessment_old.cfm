...
|------------|------------|--------------------------------------------------------------------|
| S Farmer   | 09/19/2011 | Project 12352  link to print file listed in error    Project 12352 |
|            |            |                                                                    |
----------------------------------------------------------------------------------------------->
...
<cfif isDefined("url.Type")> <cfset type=type> <cfelse> <cfset type=''> </cfif>
<cfoutput>
<!--- Report modified under project 36358 by Jaime Cruz on 5/13/09 --->		
<!--- <form name="AssessmentSummary" ACTION="//pine/reports/tips/tips4/AssessmentToolSummary-OB3.rpt" method="Post" target="AssessmentReport"> --->  <!--- S Farmer 12352 --->
	<form name="AssessmentSummary" ACTION="//#crserver#/reports/tips/tips4/AssessmentToolSummary-v3.rpt" method="Post" target="AssessmentReport">  <!--- S Farmer 12352 --->
	...
	<input type="hidden" name="prompt3" value="#type#">
</form>
