...
<cfsavecontent variable="PDFhtml">
	<cfheader name="Content-Disposition" value="attachment;filename=Assessment-care-Summary.pdf">
				...
				<table width="50%"  cellspacing="2" cellpadding="2" style="float: left;"> 
					<tr> 
					   <td style="text-align:left; font-family: Arial, Helvetica, sans-serif; font-size:12px">
							...
							<br> &nbsp;&nbsp;&nbsp;#sp_assessmenttoolsummary.caddressline1#</br> <!---  #sp_assessmenttoolsummary.cPreviousAddressLine1#--->  
...
<cfdocumentitem type="header" evalAtPrint="true">
	<cfif cfdocument.currentpagenumber eq 1>
		<cfoutput>
			<table width="95%"  cellspacing="2" cellpadding="2" style="border-bottom:1px solid black;margin:0px;">
	...
	<cfelse>
		<cfoutput>
			<table width="95%"  cellspacing="2" cellpadding="2" style="margin:0px;">
						<tr> <td style="font-family: Arial, Helvetica, sans-serif; font-size:17px; text-align:center; font-weight:bolder;">
						Assessment and Negotiated Service Plan Summary </td> <tr>
						<tr> <td> &nbsp;</td></tr>
			</table>
