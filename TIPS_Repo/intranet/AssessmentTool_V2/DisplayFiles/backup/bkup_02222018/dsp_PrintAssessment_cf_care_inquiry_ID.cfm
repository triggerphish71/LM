<!---    
===============================================================================================
Gthota - 06/21/2017 - Created initial file to get Inquiry assessment print for care plan department with only selected service plan option.
===============================================================================================
--->
		...
		<div>
				...
				<!---	<tr>
					...
					<tr> 
					   ...
					   <td width="25%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> Lvl 1=$16.00</td>
					</tr>
					<tr> 
					   <td width="25%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> 10-19 points  </td>
					   <td width="25%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> Lvl 2=$32.00</td>
					</tr>	
					<tr> 
					   <td width="25%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> 20-29 points  </td>
					   <td width="25%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> <cfif #session.qselectedhouse.ihouse_ID# eq 25 or #session.qselectedhouse.ihouse_ID# eq 66>Lvl 3=$47.00<cfelse>Lvl 3=$46.00</cfif></td>
					</tr>
					<tr> 
					   <td width="25%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> 30-39 points  </td>
					   <td width="25%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> Lvl 4=$62.00</td>
					</tr>	
					<tr> 
					   <td width="25%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> 40-49 points  </td>
					   <td width="25%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> <cfif #session.qselectedhouse.ihouse_ID# eq 25 or #session.qselectedhouse.ihouse_ID# eq 66>Lvl 5=$77.00<cfelse>Lvl 5=$76.00</cfif></td>
					</tr>
					<tr> 
					   <td width="25%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> 50-59 points  </td>
					   <td width="25%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> <cfif #session.qselectedhouse.ihouse_ID# eq 25 or #session.qselectedhouse.ihouse_ID# eq 66>Lvl 6=$92.00<cfelse>Lvl 6=$91.00</cfif></td>
					</tr>	
					<tr> 
					   <td width="25%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> 60 points and above  </td>
					   <td width="25%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> Lvl 6+ ($2 a pt)</td>
					</tr>	 --->	
				</table>
	</div>
				...
				<td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px; border-bottom:1px solid gray;">
		    	   <b> Daily Service Level Rates </b>
					...
					<tr> 
					   ...
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> Lvl 1=$15.00</td>
					</tr>
					<tr> 
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> 10-19 points  </td>
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> Lvl 2=$30.00</td>
					</tr>	
					<tr> 
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> 20-29 points  </td>
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> Lvl 3=$44.00</td>
					</tr>
					<tr> 
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> 30-39 points  </td>
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> Lvl 4=$59.00</td>
					</tr>	
					<tr> 
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> 40-49 points  </td>
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> Lvl 5=$73.00</td>
					</tr>
					<tr> 
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> 50-59 points  </td>
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> Lvl 6=$87.00</td>
					</tr>	
					<tr> 
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> 60 points and above  </td>
					   <td width="20%" style="text-align:left;font-family: Arial, Helvetica, sans-serif; font-size:12px"> Lvl 6+ (1.85 a pt)</td>
					</tr>		
		</table>
