...
<CFELSE>
	...
	<cfif check.recordcount eq 0>
		<CFQUERY NAME="check" DATASOURCE="#application.datasource#">
			...
			( iServiceCategory_id, cDescription, fWeight,flWeight, cGrouping, cSortOrder, bApprovalRequired, cRowStartUser_ID, dtrowstart ,bsubselect ,imultipleselect )
			VALUES
			( #form.iservicecategory_id#, '#form.cdescription#', '#form.fweight#','#trim(form.flweight)#', NULL, '#form.cSortOrder#', 
