...
<CFELSE>
	...
	<cfif check.recordcount eq 0>
		<CFQUERY NAME="check" DATASOURCE="#application.datasource#">
			...
			( iServicelist_id, cDescription, fWeight, cGrouping, cSortOrder, bApprovalRequired, cRowStartUser_ID, dtrowstart)
			VALUES
			( #trim(form.iservicelist_id)#, '#trim(form.cdescription)#', '#trim(form.fweight)#', NULL, '#trim(form.cSortOrder)#', 
