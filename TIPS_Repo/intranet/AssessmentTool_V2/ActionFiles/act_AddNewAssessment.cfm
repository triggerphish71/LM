...
<cfscript>
	...
	{
		/*if( Left( FieldArray[i] , 8) EQ 'Service_' )
		{
	   ...
	   //look for subservices first
		...
		else if(FindNoCase("notes",FieldArray[i]) )
		{
	...
	Assessment = Assessment.New(Form["assessmentTool"]
							...
							//   ,residentId
							  ...
							  // ,"" //application.CensusDBServer
							   ,Form["statuscode"]
							   ,Form["diagnosis"]
							   // project 88898 Ganga - Added new 7 dropdowns
							   ,Form["Primary"]
							   ,Form["Secondary"]
							   ,Form["Third"]
							   ,Form["Fourth"]
...
<cfdump var="#NotesArray#">--->
<!---<cfdump var="#inputArTay#">---> 
<!---<cfdump var="#ServicTextArray#">
<cfabort>--->
