				...
				{	
					...
					if(x + 1 < Services.length)
					{
						...
						{  
							...
							html += '" value="no" id="base" name="service_' + Services[x][6] +  '" CHECKED>No<input type="radio" onclick="DisableAllServices(this,\'pointsSpan\');CalculatePoints(\'pointsSpan\',' + Services[x][8] + ',' + Services[x][0] +  ',this)';
						...
						else
						{
							...
							{  
								...
								html += '&nbsp;' + Services[x][8] + ' points<div name="notes_' + Services[x][6] + '" id="notes_' + Services[x][6] + '"><a href="javascript:ShowNotes(\'notes_' + Services[x][6] + '\');EnableParent(\'service_' + Services[x][6] + '\')">add notes</a></div></td></tr>';
							 // This changes Ends here for project 41315-B (Documented this for ease of the developer who is moving this code)
							}
