...
function ChangeActDate(){
	adddays = document.getElementById('idNextReviewDate'); 
	actdate = document.getElementById('idActiveBillingDate');
	nbrdays = document.getElementById('iddspDaysnextassessment');	
 
	alert("show_calendar4" + " : " +  adddays.value + " : " + actdate.value + " : " + nbrdays.value);
	}	
</script>
</cfoutput>