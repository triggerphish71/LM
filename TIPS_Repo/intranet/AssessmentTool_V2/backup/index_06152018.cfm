...
| gthota   | 02/22/2018 | updated region names  to ids                                        |
------------------------------------------------------------------------------------------------>
<!--- include TIPS header --->
<META HTTP-EQUIV="Pragma" CONTENT="no-cache">
<link  rel="stylesheet" href="Styles\style.css">
 
 <!---  Gthota - Assessment maintenance--->
<!---
<cfif (session.username NEQ 'gthota')or (session.username NEQ 'tbates')> <!--- or (session.username EQ 'tbates')  --->
<img src="Images\Enlivant_logo.jpg"> <br/>
<font size='7' color = 'slateblue' align='center'> Assessment system under maintenance, Please login back later. 
...
<cfquery name="CheckRegion" datasource="#Application.Datasource#">
	...
	,OpsArea.cName AS OpsAreaName ,OpsArea.iOpsArea_ID,Region.cName AS RegionName ,HouseLog.dtCurrentTipsMonth, TenantMissingItems.TenantWithMissingItems,House.iBondHouse
	FROM House
 ...
 <!--- Gthota  added to check the active region list in TIPS --->
 <cfquery name="CheckRegionlist" datasource="#Application.Datasource#">
    SELECT cName AS OpsAreaName ,iOpsArea_ID
	FROM  OpsArea		
 ...
 <cfset Regionlist = #valuelist(CheckRegionlist.iOpsArea_ID,",")#>
 <!---
 <cfif ListFind(Regionlist, "#CheckRegion.iOpsArea_ID#")>
  This region  - #CheckRegion.iOpsArea_ID# - #CheckRegion.OpsAreaName#
 <cfelse>
   no region data available for you to test -
 </cfif> 
--->
<!---<cfdump var="#CheckRegion#">--->
<cfdump var="#fuse#">
...
<!--- Gthota  -Start code 10-03-2017 for care printer--->	
	<cfcase value="printAssessmentcare">
	  <cfif CheckRegion.StateCode EQ 'ID'>	 <!--- Added code for Idaho houses report.  Ganga-04/26/17 --->
	...
	<cfcase value="printAssessmentcareInquiry">
	  <cfif CheckRegion.StateCode EQ 'ID'>	 <!--- Added code for Idaho houses report.  Ganga-06/24/17 --->
