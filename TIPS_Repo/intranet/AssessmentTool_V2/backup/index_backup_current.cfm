...
<cfswitch expression="#fuse#">
	...
	<cfcase value="printAssessment">		 		
		  <cfinclude template="DisplayFiles_OLD\dsp_PrintAssessment.cfm">		
	</cfcase>
	...
	<cfcase value="printAssessmentEnquiry">
	  <cfif CheckRegion.StateCode EQ 'ID'>	 <!--- Added code for Idaho houses report.  Ganga-06/24/13 --->
	      <cfinclude template="DisplayFiles\dsp_PrintAssessment_enquiry_ID.cfm">
	   <cfelse>		
		  <cfinclude template="DisplayFiles\dsp_PrintAssessment_enquiry.cfm">	
	   </cfif>	  		
	</cfcase>
