...
function show_calendar2(str_target, str_datetime, DateObject) {
	...
	var str_buffer = new String (
		...
		str_target+"', '"+ dt2dtstr2(dt_prev_month)+"','" + DateObject + "');\" style='color:white;'> < "+
		//"<img src=\"prev.gif\" width=\"16\" height=\"16\" border=\"0\""+
		//" alt=\"previous month\">
		"</a></td>\n"+
		"	<td bgcolor=\"#4682B4\" colspan=\"5\" style='text-align:center;'>"+
		"<font color=\"white\" face=\"tahoma, verdana\" size=\"2\">"
		+arr_months[dt_datetime.getMonth()]+" "+dt_datetime.getFullYear()+"</font></td>\n"+
		"	<td bgcolor=\"#4682B4\" align=\"right\"><a href=\"javascript:window.opener.show_calendar2('"
		+str_target+"', '"+dt2dtstr2(dt_next_month)+"','" + DateObject + "');\" style='color:white;'> > "+
	...
	while (dt_current_day.getMonth() == dt_datetime.getMonth() ||
		...
		for (var n_current_wday=0; n_current_wday<7; n_current_wday++) {
				...
				if (dt_current_day.getMonth() == dt_datetime.getMonth())
					...
					".value='"+dt2dtstr2(dt_current_day)+"'; window.opener.document.getElementById('" + DateObject + "').onblur();window.close();\">"+
	...
	vWinCal = window.open("", "Calendar", "width=200,height=250,status=no,resizable=yes,top=200,left=200,status=yes,menubar=yes");
	vWinCal.opener = self;
	vWinCal.focus();
