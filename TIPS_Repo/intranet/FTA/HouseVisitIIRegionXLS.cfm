...
<cfset dsRegionId = helperObj.qryDashboardRegion()>	
<cfloop query="dsRegionId">
	...
	<cfcatch type="any">
		<cfmail to="sfarmer@alcco.com" from="FTA_HouseVisit_Region_XLS.cfm@alcco.com" subject="House Visit Region XLS failed" type="html">
