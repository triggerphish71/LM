...
// reset row count			 
		...
		//    alert("You entered: " + mySplitResult[1]);
		 ...
		 if   ((document.getElementById('dtDayOfMonth').value  - 1)  == 0 )
			...
			var subTotalA = (monthday *  (document.frmEditHouseVisitEntryII.marroutineord1.value));
		  ...
		  //    alert( subTotal + " : " + subTotalA + " : " + monthday + " : " + MarErrorTotal);
			if (isNaN(MarErrorTotal))
				...
				{ document.getElementById('marerrorrate1').value = 0;	
				 alert("WARNING: MAR values are missing, please re-enter or enter 0");	}	
			else if (document.frmEditHouseVisitEntryII.DayOfMonth.value  == 1)
				{ document.getElementById('marerrorrate1').value = 0;	
				 alert("WARNING: Day of the month is 1 , use the last day of the month of the previous month.");	}		  	
			else
...
<cfinclude template="../global/Calendar/ts_picker2.js">
		...
		//		}
			...
			//	}
				...
				//	this.textChanged = false;					
					...
					document.frmEditHouseVisitEntryII.action = "HouseVisitIIEditEntry_action.cfm?Save=Yes&EntryId=#entryId#&iHouse_ID=#houseId#&SubAccount=#subAccount#&DateToUse=#dateToUse#";
					// Exicute the Form's Submit() action.
					document.frmEditHouseVisitEntryII.submit();
	...
	<body>
		...
		<form id="frmEditHouseVisitEntryII" name="frmEditHouseVisitEntryII" method="post" action="HouseVisitIIEditEntry_action.cfm?Save=Yes&EntryId=#entryId#&iHouse_ID=#houseId#&SubAccount=#subAccount#&DateToUse=#dateToUse#">
			<br />
</cfoutput>
...
<!--- <cfdump var="#dsRole#"> --->
	...
	<cfset created = DateFormat(dsActiveEntryE.dtCreated, "mm/dd/yyyy") & " " & TimeFormat(dsActiveEntryE.dtCreated, "hh:mm:ss tt")>
				<input type="hidden"  name="iEntryUserId" 		id="hdnEntryUserId" 		value="#url.iEntryUserId#" />
								...
								<cfloop index="indexname" from="1" to="#maxrep#" step="1">
									...
									<tr  style=" background-color: ##ffffff;" >
										...
										<cfif dsGroupQuestions.cRowSize is not "">
											...
											<td    style="text-align:left" colspan="5"><textarea name="txtanswer_#thisgroup#_#dsGroupQuestions.iQuestionId#_#i#" rows="#dsGroupQuestions.cRowSize#" cols="#dsGroupQuestions.cColSize#">#dsActiveEntryA# </textarea></td>		 
											...
											<cfset dsActiveEntryA = helperObj.FetchHouseVisitEntryAnswersII(entryiD, thisgroup, dsGroupQuestions.iQuestionId, i)>											 
												<cfloop query="dsGroupQuestions">
												 <cfif dsGroupQuestions.dropdown is not "">
													...
													<td>#dsActiveEntryA#<br/>
													<select name="txtanswer_#thisgroup#_#dsGroupQuestions.iQuestionId#_#i#" >
								...
								<cfELSEif dsGroups.IGROUPID is 16>
									...
									<cfloop index="indexname" from="1" to="#maxrep#" step="1">
										...
										<!--- #dsGroups.iGroupId# #dsGroupQuestions.iQuestionId# #i# --->
											...
											<td  colspan="5" >
											#dsActiveEntryA#
													<input type="text" name="txtanswer_#thisgroup#_#dsGroupQuestions.iQuestionId#_#i#" id="dtMarAuditDate" value="#DateFormat(dsActiveEntryA, 'mm/dd/yyyy')#" onBlur="showAuditDate()" >
													<a onClick="show_calendar2('document.frmEditHouseVisitEntryII.dtMarAuditDate',document.getElementById('dtMarAuditDate').value,'dtMarAuditDate');"> 
													<img src="../global/Calendar/calendar.gif" alt="Calendar" width="20" height="20" border="0" align="middle" style="" id="Cal" name="Cal"></a>
													<input type="hidden" name="DayOfMonth" id="dtDayOfMonth" value="">											</td>
										...
										<cfelse>
											...
											<cfset dsActiveEntryA = helperObj.FetchHouseVisitEntryAnswersII(entryID, thisgroup, dsGroupQuestions.iQuestionId, i)>
												...
												<td colspan="1"><input type="text" name="txtanswer_#thisgroup#_#dsGroupQuestions.iQuestionId#_#i#" id="#trim(dsGroupQuestions.cIDName)##i#" value="#dsActiveEntryA#" size="#dsGroupQuestions.cColSize#"  onChange="#trim(dsGroupQuestions.cOnChange)#"  style="text-align:left"; /></td>
											</cfloop>
										</cfif>
									</tr>
								</cfloop>
