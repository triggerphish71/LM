...
<br />
		...
		ATTRIBUTES="givenName,sn,displayName,cn,dn,company,member,memberof,physicalDeliveryOfficeName,Description,organization" 
		SERVER="CORPDC01" PORT="389"  FILTER="sAMAccountName=#TRIM(rclemens)#" USERNAME="#u#" PASSWORD="#p#">
	...
	<cfquery name="useraccount"  datasource="DOCLINKALC">
			...
			WHERE
				cUserName = '#TRIM(Session.UserName)#' 
	...
	<cfdump var="#useraccount#" label="DOCLINKALC_useraccount">
			...
			SERVER="CORPDC01" PORT="389"  FILTER="sAMAccountName=rclemens" USERNAME="#u#" PASSWORD="#p#">
