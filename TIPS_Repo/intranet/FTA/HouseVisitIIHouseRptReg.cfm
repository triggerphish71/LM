...
<cfparam name="THISENTRYID" default="0">
...
<Styles>
	...
	<ss:Style ss:ID="s8">
		...
		<cfoutput>
			...
			<cfset old_entry = 0>
			<cfset dsHouseRegion = helperObj.qryHouseVisitIIRegon(19)>
			...
			<cfloop query="dsHouseRegion">
				...
				<Worksheet ss:Name="#thishousename#">			 	 
					<cfset dsRegionHousesEntries = helperObj.qryHouseVisitIIRegonHouseEntry(#regionid#, #thishouse#)>
						...
						<cfloop query="dsGroups" > 
							...
							<cfloop query="dsGroupQuestionsHdr">
								...
								<Row ss:AutoFitHeight="0" ss:Height="38">
									...
									<cfset dsRegionHouses = helperObj.qryHouseVisitIIRegonHouseEntry(#regionid#, #thisHouse#)> 
...
<cffile action="write" nameconflict="overwrite" file="\\fs01\ALC_IT\temp\housevisit_reg_#regionid#_#DateFormat(Now(),'MM-DD-YYYY')#.xls" output="#xml#">
