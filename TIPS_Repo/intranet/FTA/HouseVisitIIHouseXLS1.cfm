...
<cfset dsAnswers = helperObj.FetchHouseVisitIIQueryAnswers(1)>  
<cfset dsHouseList = helperObj.qryHouseVisitIIHouseListA(1)> 	
...
<cfoutput>
	...
	<cfcatch type="any">
		<cfmail to="sfarmer@alcco.com" from="FTA_HouseVisit_House_XLS1.cfm@alcco.com" subject="House Visit House Div 1 XLS failed" type="html">
