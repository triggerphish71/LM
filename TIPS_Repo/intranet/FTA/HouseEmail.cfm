...
|------------|------------|--------------------------------------------------------------------|
| gthota    | 08/26/2014 | Sending FTA overtime/ overbudget alerts to all houses      |
----------------------------------------------------------------------------------------------->
...
<!---<cfmail to="#qldap.mail#" cc="gthota@enlivant.com" from="FTA@enlivant.com" subject="FTA Labor Alerts." type="html">--->
