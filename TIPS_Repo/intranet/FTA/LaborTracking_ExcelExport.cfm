...
<cfheader name="Content-Disposition" value="attachment; filename=Labor Tracking #datetouse#.xls">
<cfcontent  type="application/vnd.ms-excel">
<cfset page = "Labor Tracking Excel">
<cfoutput>
...
<cfif conflict is 1>
	<cfset variables.colspan = 5>
<cfelse>
	<cfset variables.colspan = 4>
</cfif>
<!--- this is to prevent an empty space in the excel file --->
<cfif rollup EQ 4>
		...
		<tr>
			...
			<cfif rollup is 0>
				<cfif ccllcHouse is 0>
					<!---<td colspan="4" rowspan="3"><font size="-2" color="white">1EmptyCell</font></td>--->
					<td colspan="#variables.colspan#" rowspan="3">
						<cfif PtoPFormat gte '201201'>
							<table id="tbl2" cellspacing="0" cellpadding="1" border="1px">
								<tr>
									<cfif conflict is 1>
										<th colspan="6" bgcolor="#headerCellColor#" style="#topPaneStyle#">
									<cfelse>
										<th class="locked" colspan="4" bgcolor="#headerCellColor#" style="#topPaneStyle#"></cfif>
								...
								<tr>
									<th colspan="1" " style="#topPaneStyle#">
										<font size="-1">
											Actual
										</font>
									</th>				
									<th colspan="1"  style="width: 0px; #topPaneStyle#">
										<font size="-1">  
											Var Bgt
										</font>
									</th>
		...
		<cfif rollup is 0>
			<cfif ccllcHouse is 0>
				<cfif cLaborTrackingCategory is not "WD Salary" and cLaborTrackingCategory is not "Kitchen Training">			
					...
					<cfelse>   
					 <!--- ganga 03/01/2018  added code  ---> 
					   <cfif cLaborTrackingCategory is "Activities" or cLaborTrackingCategory is "Housekeeping" or cLaborTrackingCategory is "Maintenance" or cLaborTrackingCategory is "MA - AA">
							<th bgcolor="#headerCellColor#" colspan="4">    <!--- ganga 03/01/2018   added col lengh  3-4  --->
								<font size="-1" color="white">
									#cDisplayName# Hours 
								</font>
							</th>
...
--->				<cfelse>
<!--- Ganga 03/01/2018  added col lengh 3-4 --->
                   <cfif cLaborTrackingCategory is "Activities" or cLaborTrackingCategory is "Housekeeping" or cLaborTrackingCategory is "Maintenance" or cLaborTrackingCategory is "MA - AA">
					<th bgcolor="#headerCellColor#" colspan="4">   <!--- Ganga 03/01/2018  added col lengh 3-4 --->
						<font size="-1" color="white">
							#cDisplayName# Hours
		...
		<cfif rollup is 0>
			<cfif ccllcHouse is 0>
				<cfif cLaborTrackingCategory is not "WD Salary" and cLaborTrackingCategory is not "Kitchen Training">
					...
					<cfelse>   <!--- ganga 03/01/2018  added code --->
						<cfif cLaborTrackingCategory is "Activities" or cLaborTrackingCategory is "Housekeeping" or cLaborTrackingCategory is "Maintenance" or cLaborTrackingCategory is "MA - AA">	
						<th colspan="4" bgcolor="#emptyCellColor#" align=center>   <!--- Gthota 03/01/2018  added colspan 4 from 3 --->
							<font size="-1">
								&##160; 
							</font>
						</th>
...
--->			<cfelse>
             <!---   Ganga 03/01/2018  added code for OT  --->
                <cfif cLaborTrackingCategory is "Activities" or cLaborTrackingCategory is "Housekeeping" or cLaborTrackingCategory is "Maintenance" or cLaborTrackingCategory is "MA - AA">	
					<th colspan="4" bgcolor="#emptyCellColor#" align=center>    
						<font size="-2">
							Total Actual Hours vs Variable Budget
		...
		<cfif rollup is 0>
			<cfif ccllcHouse is 0>
				<cfif cLaborTrackingCategory is not "WD Salary" and cLaborTrackingCategory is not "Kitchen Training">
					...
					<!--- Gthota 3/2/2018  replace heading from 'Actual' to Regular text  --->
							 <cfif cLaborTrackingCategory is "Activities" or cLaborTrackingCategory is "Housekeeping" or cLaborTrackingCategory is "Maintenance" or cLaborTrackingCategory is "MA - AA"
							 or cLaborTrackingCategory is "Other" or cLaborTrackingCategory is "Training">	
								<th bgcolor="#emptyCellColor#" style="#topPaneStyle#">
									<font size="-1">
						...
						<!--- Gthota 3/01/2018 Added headed OT  --->		
							<cfif cLaborTrackingCategory is "Activities" or cLaborTrackingCategory is "Housekeeping" or cLaborTrackingCategory is "Maintenance" or cLaborTrackingCategory is "MA - AA">	
								<th bgcolor="#emptyCellColor#" style="#topPaneStyle#">
									<font size="-1">
										Overtime                          
			...
			<cfelse> <!--- rollup is not 0 --->
				<cfif cLaborTrackingCategory is not "Kitchen Training" and cLaborTrackingCategory is not "WD Salary" >
					...
					<cfelse>
						...
						<!--- Gthota 3/02/2018 Added headed OT  --->
							<!--- Gthota 3/01/2018 Added headed OT  --->		
							<cfif cLaborTrackingCategory is "Activities" or cLaborTrackingCategory is "Housekeeping" or cLaborTrackingCategory is "Maintenance" or cLaborTrackingCategory is "MA - AA">	
								<th bgcolor="#emptyCellColor#" style="#topPaneStyle#">
								<font size="-1">
	...
	<cfloop query="dsCensusDetails">
		<tr>
		 	<td class="locked" colspan="4" bgcolor="#emptyCellColor#" align="right" style="#leftPaneStyle#">
				<font size="-1">
				<cfif rollup is 3>
					<strong>#dsCensusDetails.cName# </strong>
				<cfelseif rollup is 2>
					<strong>#dsCensusDetails.cName# </strong>
				<cfelseif rollup is 1>
					<strong>#dsCensusDetails.cName# </strong>				
			...
			<cfif rollup is 2>
				<cfset dsRegionalCensusDetails = #helperObj.FetchAverageDailyCensusDetailsRollup(#dsCensusDetails.iOPSArea_ID#, FromDate, ThruDate,monthforqueries)#>
							...
							<cfdefaultcase>
								...
								<cfelse>
									<cfif cLaborTrackingCategory is not "Kitchen Training">
										<!--- Add the current category's hours to the daily total. --->
										<cfset totalDailyHours = #totalDailyHours# + #fregular#+#Fovertime#>  <!--- Ganga 03/05/2018 replaced with fall to fregular = fovertime --->
										<!--- Stores the current Column's Variance, which is Var Bgt minus Actual Hours --->
										<cfset categoryVariance = #fVariableBudget# - (#fRegular#+#fOvertime#)>  <!--- Ganga 03/01/2018 Added regular and ot hours --->
									<!---	<cfset categoryVariance = #fVariableBudget# - #fAll#>	 ---> <!--- Gthota 2/26/2018  replace with fRegular  --->						
										...
										<!--- Gthota 03/01/2018  Added OT code--->
										<cfif cLaborTrackingCategory is "Activities" or cLaborTrackingCategory is "Housekeeping" or cLaborTrackingCategory is "Maintenance" or cLaborTrackingCategory is "MA - AA">
										<td align="right" style="padding-right: 5px;"> 
										 	<font size="-1">
										 		#helperObj.LaborNumberFormat(fovertime, "0.0")# 		 
...
<cfset totalDailyHours = 0>
<cfset totalDailyHoursOT = 0>      <!--- Ganga 03/01/2018 added code - set up variable --->
					...
					<cfswitch expression="#cLaborTrackingCategory#">
						...
						<cfdefaultcase>
							...
							<!---	<cfset totalDailyHours = #totalDailyHours# + #fAll#>  --->  <!--- Gthota 02/26/2018  Replace code with fAll to fRegular  --->	
								...
								<cfset totalDailyHoursOT = #totalDailyHoursOT# + #fovertime#>
								<!--- Stores the current Column's Variance, which is Var Bgt minus Actual Hours --->
								<!--- <cfset categoryVariance = #fVariableBudget# - #fAll#>	--->  <!--- Gthota 02/26/2018  Replace code with fAll to fRegular  --->	
								<cfset categoryVariance = #fVariableBudget# - (#fRegular# + #fOvertime#)>	 <!--- Gthota 3/01/2018  added fovertime  --->			 
								<!--- Display the Non-Nursing Hours. --->
								<td align="right" style="padding-right: 5px;"> 
								 	 <font size="-1"> 
						 ...
						 <!--- Gthota 03/01/2018  Added overtime code  --->
								<cfif cLaborTrackingCategory is "Activities" or cLaborTrackingCategory is "Housekeeping" or cLaborTrackingCategory is "Maintenance" or cLaborTrackingCategory is "MA - AA">	                                          
								<td colspan="1" align="right"   style="padding-right: 5px;">
								  	<font size="-1">
										#helperObj.LaborNumberFormat(fOvertime, "0.00")#
									</font>
								</td>
								</cfif>                                                  
						<!---  ganga end code --->
			...
			<cfif cLaborTrackingCategory is not "WD Salary" and cLaborTrackingCategory is not "Kitchen Training">
				...
				<cfif bIsVisible eq true>
					<cfif cLaborTrackingCategory is "WD Hourly">
						...
						<cfif open is 1 or conditionalTrue is 1>
							<cfset totalMtdBudgetHours = #totalMtdBudgetHours# + #totalvarbgt#>						
						...
						<cfif open is 1 or (conditionalTrue is 1 and conflict is 0)>
							<cfset categoryMtdVariance = #totalvarbgt# - (#fRegular# + #fOvertime#)>   
					...
					<cfelse>					
						<!--- Add the current category's hours to the daily total. --->
						<cfset totalMtdHours = #totalMtdHours# + #fRegular#+#fovertime#>     <!---GThota 02/26/2018  replaced code with fAll to fRegular  --->
						<!--- Stores the current Categories MTD Variance --->
						<cfset categoryMtdVariance = #fVariableBudget# - (#fRegular#+#fovertime#)>   <!---GThota 02/26/2018  replaced code with fAll to fRegular  --->
						...
						<cfif bIsTraining eq true>
							...
							<td align="right" bgcolor="#totalcellcolor#" style="padding-right: 5px;">
							 	<font size="-1">
									<strong>
										#helperObj.LaborNumberFormat(fRegular, "0.0")#   <!---GThota 02/26/2018  replaced code with fAll to fRegular  --->
									</strong>
								</font>
							</td>
							<!---  GThota 03/01/2018  commented for training hours  
							<td align="right" bgcolor="#totalcellcolor#" style="padding-right: 5px;">
							 	<font size="-1">
									<strong>
										#helperObj.LaborNumberFormat(fovertime, "0.0")# 
						...
						<cfelse>				
							...
							<td align="right" bgcolor="#totalcellcolor#" style="padding-right: 5px;">
							 	<font size="-1">
									<strong>
										#helperObj.LaborNumberFormat(fRegular, "0.0")#  <!---GThota 02/27/2018  replaced code with fAll to fRegular  --->
									</strong>
								</font>
							</td>
					<!---Ganga 03/01/2018  added code for OT hours  --->
					  <cfif cLaborTrackingCategory is "Activities" or cLaborTrackingCategory is "Housekeeping" or cLaborTrackingCategory is "Maintenance" or cLaborTrackingCategory is "MA - AA">
							<td align="right" bgcolor="#totalcellcolor#" style="padding-right: 5px;">
							 	<font size="-1">
									<strong>
		...
		<cfif ccllcHouse is 0>
			<cfif cLaborTrackingCategory is not "WD Salary" and cLaborTrackingCategory is not "Kitchen Training">
				...
				<cfelse>
					...
					<!--- Display the Non-Nursing Hours. --->
					<cfif  cLaborTrackingCategory is "Housekeeping" or cLaborTrackingCategory is "Maintenance" or cLaborTrackingCategory is "MA - AA"
					or cLaborTrackingCategory is "Other">
					<td align="right" bgcolor="#budgetCellColor#" style="padding-right: 5px;">  <!--- gthota 03/02/2018   added code --->
						<font size="-1">
							&##160;
						</font>
					</td>
		...
		<cfif ccllcHouse is 0>
			<cfif cLaborTrackingCategory is not "WD Salary" and cLaborTrackingCategory is not "Kitchen Training" and cLaborTrackingCategory is not "Resident Care Training">
				...
				<cfelse>
					...
					<cfset variableBudgetVarianceTotal = variableBudgetVarianceTotal + (fVariableBudget - (fRegular+fOvertime))>	<!--- Ganga 03/01/2018  added regulat and OT --->		
					<cfset Factual= (dsTotalLaborTrackingData.fregular+ dsTotalLaborTrackingData.fovertime)>
					<!--- Display the Non-Nursing Hours. --->
			<!---		<cfif cLaborTrackingCategory is "Activities" or cLaborTrackingCategory is "Housekeeping" or cLaborTrackingCategory is "Maintenance" or cLaborTrackingCategory is "MA - AA">
					<td align="right" bgcolor="#variableBudgetVarianceCellColor#" style="padding-right: 5px;">  <!--- ganga 03/02/2018    added code --->
						<font size="-1">
							&##160;
						</font>
					</td> 
					...
					<td align="right" bgcolor="#variableBudgetVarianceCellColor#" style="padding-right: 5px;">
						<font size="-1" color="<cfif (fVariableBudget - Factual) lt 0 or (fVariableBudget - fall) LT 0>Red<cfelse>Black</cfif>">
							<strong>
								...
								<cfelse>
								#helperObj.LaborNumberFormat(fVariableBudget - (fRegular+fOvertime) , "0.00")# <!---Mshah changed here---> <!--- Gthota 02/27/2018  Replaced code with fRegular instead of fAll --->
								</cfif>
							</strong>
						</font>
					</td>
