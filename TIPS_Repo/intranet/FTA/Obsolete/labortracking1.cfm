...
<tr>
<th class="locked" bgcolor="#budgetcellcolor#" align=right><font size=-1>MTD Budget</th>
...
<cfloop query="getColumns">
	<!--- The Nursing Sub-Total columns will be placed before kitchen services. --->
	<cfif vcLaborCategory is "Kitchen">
		<th align=right bgcolor="#budgetcellcolor#"><font size=-1>#NumberFormat(budgetNursingTotal, "0.0")#</font></th>
		<th align=right bgcolor="#budgetcellcolor#"><font size=-1>0.0</font></th>
		<th align=right bgcolor="#budgetcellcolor#"><font size=-1>0.0</font></th>
	</cfif>	
	<th align=right bgcolor="#budgetcellcolor#">
...
<th align=right bgcolor="#budgetcellcolor#"><font size=-1>#NumberFormat(evaluate(training), "0.0")#</font></th>
		<cfset addrowTota = #QueryAddRow(QueryForCategoryGrandTotal,1)#>
...
<th align=right bgcolor="#budgetcellcolor#"><font size=-1>#NumberFormat(budgettotal, "0.0")#</font></th>
	<cfset addrowTota = #QueryAddRow(QueryForCategoryGrandTotal,1)#>
	...
	<cfset adddataTotal = #querysetcell(QueryForCategoryGrandTotal,"BudgetOrActual","Budget")#>
<!--- VARIANCE --->
<th bgcolor="f4f4f4" align=center><font size=-2>&##160;</font></th>
<!--- PTO --->
<th align=right bgcolor="#budgetcellcolor#"><font size=-1>0.0</font></th>
		<cfset addrowTota = #QueryAddRow(QueryForCategoryGrandTotal,1)#>
		...
		<cfif vcLaborCategory is "Resident Care" or vcLaborCategory is "Nurse Consultant" or vcLaborCategory is "LPN - LVN" or vcLaborCategory is "Kitchen">
			...
			<cfif vcLaborCategory is "Resident Care" or vcLaborCategory is "Nurse Consultant" or vcLaborCategory is "LPN - LVN">
				...
				<cfif findDayLaborCategoryOther.recordcount is not "0">
					<font size=-1>#NumberFormat(findDayLaborCategoryOther.Hours, "0.0")#
					<cfif findDayLaborCategoryOther.Hours is ''>
						<Cfset HoursToAdd = "0">
					<cfelse>
						<cfset HoursToAdd = #findDayLaborCategoryOther.Hours#>
					</cfif></td>
					<!--- Update the Nursing Total Hours Accumulator. --->
					<cfif vcLaborCategory is "Resident Care" or vcLaborCategory is "Nurse Consultant" or vcLaborCategory is "LPN - LVN">
						<cfset nursingTotalHours = #nursingTotalHours# + #HoursToAdd#>
					</cfif>
					<cfset daytotal = #daytotal# + #HoursToAdd#>                                                                                                                                                                                                                                    ToAdd#>
					<cfset addrowTota = #QueryAddRow(QueryForCategoryTotals,1)#>
					<cfset adddataTotal = #querysetcell(QueryForCategoryTotals,"Day",dayx)#>
...
<cfloop query="getColumns">
	<cfif vcLaborCategory is "Resident Care" or vcLaborCategory is "Nurse Consultant" or vcLaborCategory is "LPN - LVN" or vcLaborCategory is "Kitchen">
		...
		<cfif vcLaborCategory is "Kitchen">
			...
			<td bgcolor="#totalcellcolor#"><font size=-1><strong>#NumberFormat(budgetNursingTotal, "0.0")#</strong></font></td>
			<td bgcolor="#totalcellcolor#"><font size=-1><strong>#NumberFormat(nursingMtdActualTotal, "0.0")#</strong></font></td>
			<td bgcolor="#totalcellcolor#"><cfif nursingMtdVariance LT 0><font size=-1 color="red"><cfelse><font size=-1></cfif><strong>#NumberFormat(nursingMtdVariance, "0.0")#</strong></font></td>
		</cfif>
