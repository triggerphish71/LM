...
<!--- 								<cfif IsNumeric("dsDashboardHouseOccupancy.fOccupiedUnits") is "yes" and IsNumeric("dsDashboardHouseOccupancy.fOccupiedUnitsBudget") is "yes"> corrected IsNumeric 09-21-11 S Farmer tkt 78047 --->
							...
							<td align="right" colspan=1 bgcolor="#budgetCellColor#">
								<font size=-1>
									<cfif rollup is 3>Phone Number:<cfelseif rollup is 2>Phone Number: <cfelse>Residence Director:</cfif>
								</font>
							</td>
							<td align="Middle" colspan="1" bgcolor="#secondaryCellColor#">
								<font size=-1>
						...
						<tr>
							...
							<td align="right" colspan=1 bgcolor="#budgetCellColor#">
								<font size=-1>
									<cfif rollup is 3>RDQCS:<cfelseif rollup is 2>DVPSM: <cfelse>Wellness Director:</cfif>
								</font>
							</td>
							<td align="Middle" colspan="1" bgcolor="#secondaryCellColor#">
								<font size=-1>
									<cfif rollup is 3> <cfset row5 = #dsDashboardHouseInfo.RDQCSFullName#>
						...
						<tr>
							...
							<td align="Middle" colspan="1" bgcolor="#secondaryCellColor#">
								<cfif rollup is 3>	
										<cfset dsDashboardContactInfo = #helperObj.FetchRollupContactInfo(#dsDashboardHouseInfo.RDQCSFullName#)#>
										<font size=-1>
											<cfif dsDashboardContactInfo.recordcount is not 0>
												<cfif #dsDashboardContactInfo.PhoneNumber# is ""> 1-888-252-5001 <cfelse>#dsDashboardContactInfo.PhoneNumber#</cfif>
											<cfelse>
												<cfif #dsDashboardHouseInfo.RDQCSPhoneNumber# is ""> 1-888-252-5001 <cfelse>#dsDashboardHouseInfo.RDQCSPhoneNumber#</cfif>
											</cfif>
										</font>
								<cfelseif rollup is 2> 
