...
<cfset dsAnswers = helperObj.FetchHouseVisitIIQueryAnswers()>
<cfset dsHouseList = helperObj.qryHouseVisitIIHouseList()>		
...
<cfoutput>
	...
	<cfcatch type="any">
		<cfmail to="sfarmer@alcco.com" from="FTA_HouseVisit_House_XLS.cfm@alcco.com" subject="House Visit House XLS failed" type="html">
