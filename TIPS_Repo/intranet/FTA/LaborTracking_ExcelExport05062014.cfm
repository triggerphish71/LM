...
<cfscript>
	...
	//{
		...
		if (rollup is 3)	{
			dsCensusDetails = helperObj.FetchAverageDailyCensusDetailsRollup(RegionID, FromDate, ThruDate,monthforqueries);
		}
		else if (rollup is 2)	{
							...
							if (cLaborTrackingCategory is "WD Hourly")
							{
								...
								else 
								{
									if (rollup is 2)
									{
										...
										nursingBudgetTotalHours = nursingBudgetTotalHours +  dsWDHVarBgt.varbgt;
									}
									else { 
