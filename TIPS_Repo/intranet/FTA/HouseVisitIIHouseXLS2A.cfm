...
<!--- Pulls region ID's 3, 6, 17 --->
<cfset dsHouseList = helperObj.qryHouseVisitIIHouseList2A()> 
...
<cfoutput>
	<cffile action="write" nameconflict="overwrite" file="\\fs01\ALC_IT\HouseVisit\House\Test\#thisrptname#_housevisit.xls" output="#xml#"> 
	  File #thisrptname#_housevisit.xls created.<br/>  
</cfoutput>
</cfloop> <!--- dsHouseList --->
</cfprocessingdirective>
	<cfcatch type="any">
		<cfmail to="sfarmer@alcco.com" from="FTA_HouseVisit_House_XLS2.cfm@alcco.com" subject="House Visit House Div 2 XLS failed" type="html">
