...
function addRowToHFFamMem(tableid, name, maxrows, colsize, maxid){
	...
	var row = table.insertRow(rowCount);
		 ...
		 el.type = 'text';
		 el.name = 'N' + thiscellname + '_8_' + iteration;
 ...
 // 		 el.value = el.name;
	  ...
	  // 2nd cell
		 ...
		 var el = document.createElement('input');   
		 el.type = 'text';
		 el.name = 'N' + thiscellname + '_52_' + iteration;
 ...
 //		 el.value = el.name;
	  ...
	  // 3rd cell
		 ...
		 var el = document.createElement('input');   
		 el.type = 'text';
		 el.name = 'N' + thiscellname + '_9_' + iteration;
...
function addRowToNewRes(tableid, name, maxrows, colsize, maxid){
	...
	var row = table.insertRow(rowCount);
 	  ...
 	  // 1st cell
		 ...
		 var el = document.createElement('input');   
		 el.type = 'text';
		 el.name = 'N' + thiscellname + '_53_' + iteration;
 ...
 //		 el.value = el.name;
 	  ...
 	  // 2nd cell
		 ...
		 var el = document.createElement('input');   
		 el.type = 'text';
		 el.name = 'N' + thiscellname + '_27_' + iteration;
		 el.id = 'newresident' + iteration;
 //		 el.value = el.name;
		 el.size = colsize;
		 cell1.appendChild(el); 
...
// alert("rowCount: " + rowCount); 	 
 	  // 1st cell
		 ...
		 var el = document.createElement('input');   
		 el.type = 'text';
		 el.name = 'N' + thiscellname + '_7_' + iteration;
...
function addRowToProfRef(tableid, name, maxrows, colsize, maxid){
	...
	var row = table.insertRow(rowCount);
		 ...
		 var el = document.createElement('input');   
		 el.type = 'text';
		 el.name = 'N' + thiscellname + '_35_' + iteration;
...
//		 el.value = el.name;
		 ...
		 var el = document.createElement('input');   
		 el.type = 'text';
		 el.name = 'N' + thiscellname + '_36_' + iteration;
...
//		 el.value = el.name;
		 ...
		 var el = document.createElement('input');   
		 el.type = 'text';
		 el.name = 'N' + thiscellname + '_65_' + iteration;
...
function addRowToOutOfComm(tableid, name, maxrows, colsize, maxid){
	...
	var row = table.insertRow(rowCount);
		 ...
		 var el = document.createElement('input');   
		 el.type = 'text';
		 el.name = 'N' + thiscellname + '_39_' + iteration;
 ...
 //		 el.value = el.name;
		 ...
		 var el = document.createElement('input');   
		 el.type = 'text';
		 el.name = 'N' + thiscellname + '_59_' + iteration;
 ...
 //		 el.value = el.name;
	  ...
	  // 2nd cell
		 ...
		 var el = document.createElement('input');   
		 el.type = 'text';
		 el.name = 'N' + thiscellname + '_40_' + iteration;
...
// 		 el.value = el.name;
	  ...
	  // 3rd cell
		 ...
		 var el = document.createElement('input');   
		 el.type = 'text';
		 el.name = 'N' + thiscellname + '_41_' + iteration;
...
//		 el.value = el.name;
	  ...
	  // 4th cell
		 ...
		 var el = document.createElement('input');   
		 el.type = 'text';
		 el.name = 'N' + thiscellname + '_42_' + iteration;
...
function addRowToHotLeads(tableid, name, maxrows, colsize, maxid){
	...
	var row = table.insertRow(rowCount);
		 ...
		 var el = document.createElement('input');   
		 el.type = 'text';
		 el.name = 'N' + thiscellname + '_24_' + iteration;
...
//		 el.value = el.name;
		 ...
		 var el = document.createElement('input');   
		 el.type = 'text';
		 el.name = 'N' + thiscellname + '_60_' + iteration;
...
//		 el.value = el.name;
	  ...
	  // 3rd cell
		 ...
		 var el = document.createElement('input');   
		 el.type = 'text';
		 el.name = 'N' + thiscellname + '_25_' + iteration;
...
//		 el.value = el.name;
	  ...
	  // 4th cell
		 ...
		 var el = document.createElement('input');   
		 el.type = 'text';
		 el.name = 'N' + thiscellname + '_26_' + iteration;
...
function addRowToPrefProv(tableid, name, maxrows, colsize, maxid){
	...
	var row = table.insertRow(rowCount);
		 ...
		 var el = document.createElement('input');   
		 el.type = 'text';
		 el.name = 'N' + thiscellname + '_10_' + iteration;
...
// 		 el.value = el.name;
	  ...
	  // 2nd cell
		 ...
		 var el = document.createElement('input');   
		 el.type = 'text';
		 el.name = 'N' + thiscellname + '_11_' + iteration;
		 el.id = 'hotleadsstrat1' + iteration;
// 		 el.value = el.name;
		 el.size = colsize;
		 cell1.appendChild(el);
	  ...
	  // 3rd cell
		 ...
		 var el = document.createElement('input');   
		 el.type = 'text';
		 el.name = 'N' + thiscellname + '_12_' + iteration;
		 el.id = 'hotleadsstrat2' + iteration;
// 		 el.value = el.name;
		 el.size = 12;
		 cell2.appendChild(el);
	  // 4th cell
		 ...
		 var el = document.createElement('input');   
		 el.type = 'text';
		 el.name = 'N' + thiscellname + '_13_' + iteration;
		 el.id = 'hotleadsstrat2' + iteration;
// 		 el.value = el.name;
		 el.size = 12;
		 cell3.appendChild(el);
...
// alert(tableid + " : " + name  + " : " +  maxrows  + " : " +  colsize  + " : " +  maxid);
	...
	var row = table.insertRow(rowCount);
		 ...
		 var el = document.createElement('input');   
		 el.type = 'text';
		 el.name = 'N' + thiscellname + '_1_' + iteration;
...
//		 el.value = el.name;
	  ...
	  // 2nd cell
		 ...
		 var el = document.createElement('input');   
		 el.type = 'text';
		 el.name = 'N' + thiscellname + '_2_' + iteration;
...
//		 el.value = el.name;
	  ...
	  // 3rd cell
		 ...
		 var el = document.createElement('input');   
		 el.type = 'text';
		 el.name = 'N' + thiscellname + '_3_' + iteration;
...
//		 el.value = el.name;
	  ...
	  // 4th cell
		 ...
		 var el = document.createElement('input');   
		 el.type = 'text';
		 el.name = 'N' + thiscellname + '_4_' + iteration;
...
//		 el.value = el.name;
	  ...
	  // 5th cell
		 ...
		 var el = document.createElement('input');   
		 el.type = 'text';
		 el.name = 'N' + thiscellname + '_5_' + iteration;
...
//    alert("You entered: " + mySplitResult[1]);
 ...
 if   ((document.getElementById('dtDayOfMonth').value  - 1)  == 0 )
	...
	var subTotal = ((document.frmHouseVisitOpEntry.maromissions1.value - 0) + (document.frmHouseVisitOpEntry.marprn1.value - 0));
				...
				<cfloop query="dsGroups" >
					...
					<tr>
						...
						<table  id="#trim(dsGroups.cGroupName)#"      >
							<tr>
								<td> <input type="hidden" name="#trim(indexname)#" value="#maxrep#" id="id#Trim(dsGroups.indexname)#"></td>
							</tr>
							...
							<tr>
								...
								<cfif dsGroups.IGROUPID is 18 >
									...
									<TR>
										<td  style="text-align:left" colspan="5"><!--- #dsGroups.iGroupId# #dsGroupQuestions.iQuestionId# #i# --->
								...
								<cfELSEif dsGroups.IGROUPID is 6>
									...
									<TR>
										<td style="text-align:left"><!--- #dsGroups.iGroupId# #dsGroupQuestions.iQuestionId# #i# --->
											<textarea name="txtanswer_#thisgroup#_#dsGroupQuestions.iQuestionId#_#i#" rows="#dsGroupQuestions.cRowSize#" cols="#dsGroupQuestions.cColSize#"  style="text-align:left">#dsActiveEntry# </textarea>
										</td>	
									</TR>
									</cfloop>
								<cfelse>
								...
								<cfloop index="#indexname#" from="1" to="#maxrep#" step="1">
									...
									<tr  style=" background-color: ##ffffff;" >
										...
										<!--- #dsGroups.iGroupId# #dsGroupQuestions.iQuestionId# #i# --->
											...
											<td >
											<input type="hidden" name="origdate" id="idorigdate" value="#dsActiveEntry#">
											#dsActiveEntry#
