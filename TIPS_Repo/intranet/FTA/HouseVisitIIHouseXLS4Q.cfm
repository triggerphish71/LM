<!--- HouseVisitIIHouseXLS1.cfm extracts the house visit reports placing each house in a file. --->
...
<cfset dsAnswers = helperObj.FetchHouseVisitIIQueryAnswers(4)>  
<cfset dsHouseList = helperObj.qryHouseVisitIIHouseListA(4)> 	
				...
				<Worksheet ss:Name="#thishousename#">			 	 
					...
					<Table>
						...
						<Row ss:AutoFitHeight="0" ss:Height="38.25" >
							<Cell ss:StyleID="s2">
								<Data ss:Type="String">House Visits House: #XmlFormat(trim(thishousename))#, Region: #XmlFormat(Trim(thisregionname))#  Report Date Range:#XmlFormat(Trim(todaysdate))# Thru #XmlFormat(Trim(thisThruDateF))#</Data>
							</Cell>
							<cfloop  query="dsRegionHousesEntries"  >
								...
								<cfset userid = dsEntryDetail.cUserName>
								<cfif (k MOD 2 neq 0) >
						...
						<cfloop query="dsGroups" > 
							...
							<cfloop query="dsGroupQuestionsHdr">
								...
								<cfset k = 0>
									...
									<cfset j = 0>
									<cfif dsEntryAnswers.iEntryGroupId is not "">
										<cfloop query="dsEntryAnswers"> <!--- start  dsEntryAnswers --->
											 ...
											 <cfset dateVisit =  dsEntryDetail.dtHouseVisit>
											 <cfset role_Name = dsEntryDetail.cRoleName>
											 <cfset userid2 = dsEntryDetail.cUserName>
											  <cfset j = j + 1>
												<cfswitch expression="#thisgroup#">
														<cfcase value="1">
															<cfif (k MOD 2 neq 0) >
															...
															<cfcase value="2">
																<cfif j is 1>
																	<cfset maxEntryCount = helperObj.qryHouseVisitIIEntryMax(#thisentryid#)>
																	<cfset EmptyRoomCount = helperObj.qryHouseVisitIIEmpRm(#thisentryid#)>
																	<cfset maxEntry = maxEntryCount.entrycount>
																	<cfset EmptyRoomcount = EmptyRoomCount.emptyroomcount>
																	<cfif IsNumeric(maxEntry)>
																		<cfset hdrSize = maxEntry - 1>
																	<cfelse>
																		<cfset hdrSize =  1>
...
<cfoutput>
	<cffile action="write" nameconflict="overwrite" file="\\fs01\ALC_IT\HouseVisit\House\#thisrptname#_housevisitQ.xls" output="#xml#"> 
	<!--- File #thisrptname#_housevisit.xls created.<br/> --->
</cfoutput>
</cfloop> <!--- dsHouseList --->
</cfprocessingdirective>
	<cfcatch type="any">
		<cfmail to="sfarmer@alcco.com" from="FTA_HouseVisit_House_XLS4.cfm@alcco.com" subject="House Visit House Div 4 XLS failed" type="html">
