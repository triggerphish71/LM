	...
	<html>
		<head>
			...
			<cfif isDefined("url.iEntryId")>
 			...
 			<cfelse>
					<cflocation url="HouseVisitsII.cfm?Save=No&iHouse_ID=#iHouse_ID#&SubAccount=#subAccount#&DateToUse=#dateToUse#&role=#role#&numberofmonths=#url.numberofmonths#"> 
			</cfif>
					...
					<tr>
						...
						<td align="right" valign="top" colspan="1" bgcolor="#freezeColor#">
							<table width="100%" height="100%" cellspacing="0" cellpadding="0" border="0">
								...
								<tr>
									<td width="100%" height="60%" align="right" valign="top" bgcolor="#freezeColor#">
										<a style="padding: 8px;" href="HouseVisitIIEntryEdit.cfm?ccllcHouse=#ccllcHouse#&iHouse_ID=#houseId#&iEntryId=#iEntryId#&IENTRYUSERID=#userId#&EntryuserFullName=#Trim(userFullName)#&EntryuserRole=#url.EntryuserRole#&hdnrolename=#RoleName#&userRoleId=#userRoleId#&Role=#url.Role#&NumberOfMonths=#numberOfMonths#&DateToUse=#datetouse#&SubAccount=#subaccount#">
											<font size=-1>
												Edit this entry
											</font>
										</a>
