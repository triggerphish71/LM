...
<!--- 			<cfset dsQuestions = helperObj.FetchHouseVisitQuestions()> --->
			...
			return (300 );
				...
				function viewblankreport(usertype)
				{
					if (usertype.value == 1)
					{
						var newlocation = "./BlankHouseVisit_Operations.pdf";
 					}
					else if (usertype.value == 2) {
						var newlocation = "./BlankHouseVisit_Sales.pdf";	
						}		
					else if (usertype.value == 3) {
						var newlocation = "./BlankHouseVisit-Clinical.pdf";	
						}						
	...
	<cfoutput>
		...
		<cfelse>
			...
			<cfset userRoleName = "RDQCS">	
		<!--- 			<cfset userRoleName = "RDQCM">	 --->
				<cfset userRoleId = 1>
			<cfelse>    	 	
			...
			<table style="margin-bottom: 8px; width: 675px; border: 1px; border-color:##006600;  cellpadding: 0; cellspacing: 0;" >
				...
				<tr>		
					<td align="center" valign="bottom">
						<a title="Click to start filling out a new House Visit Report" href="HouseVisitII.cfm?NumberOfMonths=<cfif isDefined("url.NumberOfMonths")>#url.NumberOfMonths#<cfelse>3</cfif>&Role=<cfif isDefined("url.Role")>#url.Role#<cfelse>0</cfif>&ccllcHouse=#ccllcHouse#&iHouse_ID=#houseId#&SubAccount=#subAccount#&DateToUse=#dateToUse#&EntryuserRole=#userRoleName#&userRoleId=#userRoleId#&userRole=#userRoleName#">
					...
					<cfelseif  ((dsUserRole.cRoleName is "RDQCS") or   (dsUserRole.cRoleName is "RDQCM"))>
						<td align="center"    >
					...
					<cfif (session.username eq "sfarmer") >
				<cfset dsRolesChg = helperObj.FetchHouseVisitRolesChg()>				
					<tr>
						<td><a href="HouseVisitII_DisplayGroups.cfm">House Visit Groups Maintenance</a> </td>
						<td align="center"   >
							<label title="Opens a Blank House Visit Report"   >
								<font  color="blue">
									Blank House Visit Report, Select Role:
									...
									<div  id="tbl-container"  style="border-top-style: solid; border-top-width: 1px; border-top-color: gray;border-right-style: solid; border-right-width: 1px; border-right-color: gray; border-left-style: solid; border-left-width: 2px; border-left-color: gray;">
										<table     cellspacing="0" cellpadding="1" border="1px">
											<cfloop query="dsGroupsO">
												<tr>
													<td>#cUserDisplayName# #cRoleName# <a href="HouseVisitViewEntry.cfm?ccllcHouse=#ccllcHouse#&iHouse_ID=#url.iHouse_ID#&iEntryId=#iEntryId#&IENTRYUSERID=#userId#&EntryuserFullName=#userFullName#&EntryuserRole=#userRoleName#&hdnrolename=#cRoleName#&userRoleId=#userRoleId#&role=#url.role#&subAccount=#url.SubAccount#&DateToUse=#datetouse#"> #dateformat(dtCreated, "mm/dd/yyyy")#</a></td>
												</tr>
											</cfloop>	
										</table>
									</div>	
							...
							border-left-style: solid; border-left-width: 2px; border-left-color: gray;">
										<table   cellspacing="0" cellpadding="1" border="1px">
											<cfloop query="dsGroupsS">
												<tr>
													<td>#cUserDisplayName# #cRoleName# <a href="HouseVisitViewEntry.cfm?ccllcHouse=#ccllcHouse#&iHouse_ID=#url.iHouse_ID#&iEntryId=#iEntryId#&IENTRYUSERID=#userId#&EntryuserFullName=#userFullName#&EntryuserRole=#userRoleName#&hdnrolename=#cRoleName#&userRoleId=#userRoleId#&role=#url.role#&subAccount=#url.SubAccount#&NumberOfMonths=#numberOfMonths#&DateToUse=#datetouse#"> #dateformat(dtCreated, "mm/dd/yyyy")#</a></td>
												</tr>
											</cfloop>	
										</table>
									</div>	
