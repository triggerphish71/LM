...
<!--- <cfdump var ="#dsLaborTrackingHours#" label="dsLaborTrackingHours">   --->
...
<!--- 							  <td colspan="1" align="right" style="padding-right: 5px;">
							...
							<cfdefaultcase>
								...
								<cfelse>
									<cfif cLaborTrackingCategory is not "Kitchen Training">
										<!--- Add the current category's hours to the daily total. --->
										<cfset totalDailyHours = #totalDailyHours# + #fregular#>  <!--- Ganga 03/01/2018 replaced with fall to fregular --->
									...
									<!---	<cfset categoryVariance = #fVariableBudget# - #fAll#>	 ---> <!--- Gthota 2/26/2018  replace with fRegular  --->						
										...
										<td align="right" style="padding-right: 5px;"> 
										 	<font size="-1">
										 		#helperObj.LaborNumberFormat(fRegular, "0.0")#  
												<!--- #helperObj.LaborNumberFormat(fAll, "0.0")#  ---> <!--- Gthota 02/26/2018  replaced code with fregular instead of fAll--->
											</font>
										</td>
	...
	<tr>
		...
		<!--- loop through labor categories --->
<!---	<Cfdump var = "#dsMTDLaborCtgyHours#" label ="dsMTDLaborCtgyHours">	--->
		...
		<cfif ccllcHouse is 0>
			<cfif cLaborTrackingCategory is not "WD Salary" and cLaborTrackingCategory is not "Kitchen Training">
				...
				<cfif bIsVisible eq true>
					...
					<cfelseif cLaborTrackingCategory is "Resident Care" or cLaborTrackingCategory is "Nurse Consultant"
					 or cLaborTrackingCategory is "LPN - LVN">			
					 	<cfif  cLaborTrackingCategory is "Nurse Consultant">
					 		<td  bgcolor="#totalcellcolor#" style="padding-right:5px;text-align:right;">-</td>
					 		<td  bgcolor="#totalcellcolor#" style="padding-right:5px;text-align:right;">-</td>
					 		<td  bgcolor="#totalcellcolor#" style="padding-right:5px;text-align:right;">-</td>
					 	</cfif>  
...
<!--- 						<td colspan="1" align="right" bgcolor="#totalcellcolor#" style="padding-right: 5px;">
						...
						<cfelse>
							<td align="right" bgcolor="#totalcellcolor#"  style="padding-right: 5px;">
							  	<font size="-1">
									<strong>
										#helperObj.LaborNumberFormat(fRegular, "0.0")# -R1
									</strong>
								</font>
							</td>
							<td align="right" bgcolor="#totalcellcolor#" style="padding-right: 5px;">
							 	<font size="-1">
									<strong>
										#helperObj.LaborNumberFormat(fOvertime, "0.0")# -R2
									</strong>
								</font>
							</td>		
							<td align="right" bgcolor="#totalcellcolor#" style="padding-right: 5px;">
							 	<font size="-1">
									<strong>
										#helperObj.LaborNumberFormat(fRegular + fOvertime, "0.0")# -R3
									</strong>
								</font>
							</td>		
							<td colspan="1" align="right" bgcolor="#totalcellcolor#" style="padding-right: 5px;">
							 	<font size="-1">
									<strong>
										#helperObj.LaborNumberFormat(fVariableBudget, "0.00")# -R4
									</strong>
								</font>
							</td>
							<td align="right" bgcolor="#totalcellcolor#" style="padding-right: 5px;">
							 	<font size="-1" color="<cfif kitchenMtdVariance lt 0>Red<cfelse>Black</cfif>">
									<strong>
										#helperObj.LaborNumberFormat(kitchenMtdVariance, "0.00")# -R5
									</strong>
								</font>
							</td>		
						</cfif>
