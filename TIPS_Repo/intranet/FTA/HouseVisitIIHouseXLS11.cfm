...
<cfset dsAnswers = helperObj.FetchHouseVisitIIQueryAnswers(11)>  
<cfset dsHouseList = helperObj.qryHouseVisitIIHouseListA(11)> 	
...
<cfoutput>
	...
	<cfcatch type="any">
		<cfmail to="sfarmer@alcco.com" from="FTA_HouseVisit_House_XLS11.cfm@alcco.com" subject="House Visit House Div 11 XLS failed" type="html">
