...
<cfoutput>
	...
	<html>
		<head>
			...
			<cfelseif isDefined("url.EntryId")>
...
// reset row count	
		...
		function addRowToeveningvis(tableid, name, maxrows, colsize, maxid){
			...
			var row = table.insertRow(rowCount);
			  ...
			  // 1st cell
		 		 ...
		 		 var el = document.createElement('input');   
		 		 el.type = 'text';
		 		 el.name = thiscellname + '_69_' + iteration;
		 		 el.id = 'familymemeveningvisitFN' + iteration;
		 	  //   el.value = el.name;
		 		 el.size = colsize;
		 		 cell0.appendChild(el); 
			  // 2nd cell
		 		 ...
		 		 var el = document.createElement('input');   
		 		 el.type = 'text';
		 		 el.name = thiscellname + '_70_' + iteration;
		 		 el.id = 'familymemeveningvisitLN' + iteration;
		 	//	 el.value = el.name;
		 		 el.size = colsize;
		 		 cell1.appendChild(el); 
	//	  reset row count	
...
function addRowToOutOfComm(tableid, name, maxrows, colsize, maxid){
	...
	var row = table.insertRow(rowCount);
		 ...
		 el.type = 'text';
		 el.name = thiscellname + '_1_' + iteration;
		 el.id = 'oocommresident' + iteration;
//		 el.value = el.name;
		 el.size = colsize;
		 cell0.appendChild(el); 
	  // 2nd cell
...
var monthday = 0;
 if   ((document.frmHouseVisitOpEntry.DayOfMonth.value  - 1)  == 0 )
 	{ monthday = 1  }
else {	
 	 monthday = (document.frmHouseVisitOpEntry.DayOfMonth.value  - 1) }
	...
	var subTotalA = (monthday *  (document.frmHouseVisitOpEntry.marroutineord1.value -0));
 ...
 //  alert( subTotal + " : " + subTotalA + " : " + monthday + " : " + MarErrorTotal);
	...
	document.getElementById('marerrorrate1').value = Math.round(MarErrorTotal * 100)/100;		
}   
...
<cfinclude template="../global/Calendar/ts_picker2.js">
	...
	<body>
		...
		<form id="frmEditHouseVisitEntryII" name="frmEditHouseVisitEntryII" method="post" action="EditHouseVisitEntryII.cfm?Save=Yes&EntryId=#entryId#&iHouse_ID=#houseId#&SubAccount=#subAccount#&DateToUse=#dateToUse#">
			<br />
</cfoutput>
...
<cfoutput>
	...
	<cfset dsActiveEntryE = helperObj.FetchHouseVisitEntryByIdII(entryId)> 
...
<!--- <cfdump var="#dsRole#"> --->
	...
	<cfset entryDate = #DateFormat(dsActiveEntryE.dtHouseVisit, "mm/dd/yyyy")#>
	<cfset userId = dsActiveEntryE.cUserName>
	<cfset userFullName = dsActiveEntryE.cUserDisplayName>
	

	<cfset lastUpdate = DateFormat(dsActiveEntryE.dtLastUpdate, "mm/dd/yyyy") & " " & TimeFormat(dsActiveEntryE.dtLastUpdate, "hh:mm:ss tt")>
	<cfset created = DateFormat(dsActiveEntryE.dtCreated, "mm/dd/yyyy") & " " & TimeFormat(dsActiveEntryE.dtCreated, "hh:mm:ss tt")>
				<input type="hidden"  name="iEntryUserId" 		id="hdnEntryUserId" 		value="#form.iEntryUserId#" />
				<input type="hidden"  name="EntryuserRole" 		id="hdnEntryuserRole" 		value="#EntryuserRole#" />
				<input type="hidden"  name="EntryuserFullName" 	id="hdnEntryuserFullName" 	value="#form.EntryuserFullName#" />
				<input type="hidden"  name="hdnrolename" 		id="hdnrolename" 			value="#form.hdnrolename#" />
				<input type="hidden"  name="userRoleID" 		id="hdnuserRoleID" 			value="#form.userRoleID#" /> 
				<input type="hidden"  name="NumberOfMonths" 	id="hdnNumberOfMonths" 		value="#form.NumberOfMonths#" />
				<input type="hidden"  name="DateToUse" 			id="hdnDateToUse" 			value="#url.DateToUse#" />
				<input type="hidden"  name="role" 				id="hdnrole" 				value="#form.role#" /> 
				<input type="hidden"  name="ientryId" 			id="entryId" 				value="#url.iEntryId#" /> 
	...
	<table id="tblEditEntry" cellspacing="0" cellpadding="1" border="1px"  >
							...
							<table width="100%" height="100%" cellspacing="0" cellpadding="0" border="0">
								<tr>
									<td width="100%" height="60%" align="right" valign="top" bgcolor="#freezeColor#">
										<a style="padding: 8px;" href="HouseVisitsII.cfm?iHouse_ID=#url.iHouse_ID#&userRoleId=#userRoleId#&IENTRYUSERID=#iEntryUserId#&EntryuserFullName=#EntryuserFullName#&EntryuserRole=#EntryuserRole#&subAccount=#subAccount#&NumberOfMonths=#NumberOfMonths#&DateToUse=#DateToUse#&role=#role#">
											<font size=-1>
		...
		<tr>
			<td colspan="5" bgcolor="#toolbarColor#" style="height: 30px;">
				<table width="80%" height="100%" border="0px" cellpadding="0" cellspacing="0">
					<tr>	
					<td align="center"><input type="button" value="Save" style="width:120px" onClick="save();" ></input></td>
					<!--- 	<td align="left" width="50%" height="100%" colspan="1" bgcolor="#toolbarColor#" style="padding: 4px;">
						...
						<td align="right" width="50%" height="100%" colspan="1" bgcolor="#toolbarColor#" style="padding: 4px;">
							...
							<input type="button" value="Save" style="width:120px" onClick="save();"></input>
						</td> --->
					</tr>
				</table>
			</td>
...
<!--- 		<cfif spellCheckingActive eq true>
			<script language="javascript" type="text/javascript">
				...
				<cfloop query="dsGroups" >
					...
					<tr>
						<td  colspan="5" >
						<table  id="#trim(dsGroups.cGroupName)#"      width="80%" >
							<input type="hidden" name="#trim(indexname)#" value="#maxrep#" id="id#Trim(dsGroups.indexname)#"> 
							<tr style="background-color:##cdcdcd"; >
								<th  style="text-align:left"; font-weight:"100"  colspan="5">#dsGroups.cTextHeader#</th>
							</tr>
							...
							<tr>
								...
								<TR>
									<td   ><input type="button" value="Add Row" onClick="#Trim(dsGroups.addrowname)#('#trim(dsGroups.cGroupName)#', 'txtanswer_#thisgroup#',#maxrep#,#dsGroupQuestionsHdr.cColSize#, 'id#Trim(dsGroups.indexname)#');" /></td>
								</TR>
								</cfif>
								<cfset maxrep = #dsGroups.indexmax#> 
								<cfset indexname  = #Trim("dsGroups.indexname")# >
								...
								<cfloop index="indexname" from="1" to="#maxrep#" step="1">
									...
									<tr  style=" background-color: ##ffffff;" >
										...
										<cfset dsActiveEntryA = helperObj.FetchHouseVisitEntryAnswersII(entryiD, thisgroup, dsGroupQuestions.iQuestionId, i)>
											<td    style="text-align:left"><textarea name="txtanswer_#thisgroup#_#dsGroupQuestions.iQuestionId#_#i#" rows="#dsGroupQuestions.cRowSize#" cols="#dsGroupQuestions.cColSize#">#dsActiveEntryA# </textarea></td>		 
										
										<cfelseif dsGroupQuestions.cColSize is 1>
											<cfset dsActiveEntryA = helperObj.FetchHouseVisitEntryAnswersII(entryID, thisgroup, dsGroupQuestions.iQuestionId, i)>
											<cfset isyesorno = dsActiveEntryA>
											<td style="text-align:LEFT"  >
												<cfif trim(isyesorno) is "Y">	YES	<cfelse>NO</cfif><br/>
											</td>			
											<TD  style="text-align:LEFT">Select to Change:
										...
										<!--- #dsGroups.iGroupId# #dsGroupQuestions.iQuestionId# #i# --->
											<cfset dsActiveEntryA = dateformat(helperObj.FetchHouseVisitEntryAnswersII(entryID, thisgroup, dsGroupQuestions.iQuestionId, i),"mm/dd/yyyy")>
											<td  >
											#dsActiveEntryA#
										...
										<cfelse>
											...
											<cfset dsActiveEntryA = helperObj.FetchHouseVisitEntryAnswersII(entryID, thisgroup, dsGroupQuestions.iQuestionId, i)>
												...
												<td  ><input type="text" name="txtanswer_#thisgroup#_#dsGroupQuestions.iQuestionId#_#i#" id="#trim(dsGroupQuestions.cIDName)##i#" value="#dsActiveEntryA#" size="#dsGroupQuestions.cColSize#"  onChange="#trim(dsGroupQuestions.cOnChange)#"  style="text-align:left"; /></td>
											</cfloop>
										</cfif>
									</tr>
								</cfloop>
		...
		<tr>
			<td colspan="5" bgcolor="#toolbarColor#"  align="center" style="height: 30px;">
 					<input type="button" value="Save" style="width:120px" onClick="save();"></input>
						<!--- <td align="left" width="50%" height="100%" colspan="1" bgcolor="#toolbarColor#" style="padding: 4px;">
							  <input type="button" value="Return" style="width: 120px; margin-right: 22px;" onClick="leavePage();" />	 			
						</td> --->
<!--- 						<td align="center"   height="100%" colspan="2" bgcolor="#toolbarColor#" style="padding: 4px;">
							<!--- <input type="button" value="Check Spelling" style="width:120px; margin-right: 10px;" onClick="spellCheckAll();"></input> --->									
							<!--- <input type="button" value="Reset" style="width:120px; margin-right: 10px;" onClick="userReset();"></input> --->
