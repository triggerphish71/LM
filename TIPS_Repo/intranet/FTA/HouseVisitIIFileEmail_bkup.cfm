		...
		<cfoutput>
			...
			<!--- KB ---> 
					<cfset dsKBData = helperObj.qryHouseVisitIIEmailListVP('Bucholtz, Kathy')>
						...
						<cfset KBfirstname = listgetat(fullname,2)>
						<cfset KBlastname  = listgetat(fullname,1)>
			...
			<!--- LW ---> 
					<cfset dsLWData = helperObj.qryHouseVisitIIEmailListVP('Wolfgram, Lynn')>
						...
						<cfset LWfirstname = listgetat(fullname,2)>
						<cfset LWlastname  = listgetat(fullname,1)>
						<cfset LWemail  = #Trim(dsLWData.cemail)#>														
			<!--- JH --->
					<cfset dsJHData = helperObj.qryHouseVisitIIEmailListVP('Houck, Jared')>
						<cfset fullname= #Trim(dsJHData.cFullName)#>
						<cfset firstname = listgetat(fullname,2)>
						<cfset lastname  = listgetat(fullname,1)>
  						<cfset dsEmailList = helperObj.qryHouseVisitIIRegionList(4)>
						<cfset division_name = dsemailList.division_name>
						<cfmail to="#dsJHData.cemail#" CC="#KBemail#, #LBemail#, #LWemail#" 	from="report@alcco.com" subject="House Visit Report #division_name# Division">
						...
						<cfset division_name = dsemailList.division_name>
						<cfmail to="#dsJHData.cemail#"  CC="#KBemail#, #LBemail#" 	from="report@alcco.com" subject="House Visit Report #division_name# Division">				  	
							Attached is the weekly House Visit Report for #division_name# Division.
							<cfloop query="dsEmailList" >
								<cfset regionfilename = replace(replace(dsEmailList.regionname, " " , "_","All"),"/", "_","All")>
								<cfif FileExists("\\fs01\ALC_IT\HouseVisit\Region\reg_#regionfilename#_housevisit.xls") is "yes">
			...
			<!--- TD --->
							...
							<cfset fullname= #Trim(dsTDData.cFullName)#>
							<cfset firstname = listgetat(fullname,2)>
							<cfset lastname  = listgetat(fullname,1)>
							<cfset dsEmailList = helperObj.qryHouseVisitIIRegionList(1)>
							<cfset division_name = dsemailList.division_name>
						<cfmail to="#dsTDData.cemail#"  	from="report@alcco.com" subject="House Visit Report #division_name# Division">				  	
							Attached is the weekly House Visit Report for #division_name# Division.
							<cfloop query="dsEmailList" >
								<cfset regionfilename = replace(replace(dsEmailList.regionname, " " , "_","All"),"/", "_","All")>
								<cfif FileExists("\\fs01\ALC_IT\HouseVisit\Region\reg_#regionfilename#_housevisit.xls") is "yes">
			...
			<!--- TS --->
							...
							<cfset fullname= #Trim(dsTSData.cFullName)#>
							<cfset firstname = listgetat(fullname,2)>
							<cfset lastname  = listgetat(fullname,1)>
							<cfset dsEmailList = helperObj.qryHouseVisitIIRegionList(11)>
							<cfset division_name = dsemailList.division_name>
						<cfmail to="#dsTSData.cemail#"    CC="#KBemail#, #LBemail#" 	from="report@alcco.com" subject="House Visit Report #division_name# Division">				  	
							Attached is the weekly House Visit Report for #division_name# Division.
							<cfloop query="dsEmailList" >
								<cfset regionfilename = replace(replace(dsEmailList.regionname, " " , "_","All"),"/", "_","All")>
								<cfif FileExists("\\fs01\ALC_IT\HouseVisit\Region\reg_#regionfilename#_housevisit.xls") is "yes">
						        ...
						        <cffile action="Append" 
								file="\\fs01\ALC_IT\HouseVisit\housevisit_email_#todaydate#.txt" 
								output="emailsent #dsTSData.cFullName#, #dsTSData.cemail#, Division: #division_name#">
						        <cffile action="Append" 
								file="\\fs01\ALC_IT\HouseVisit\housevisit_email_#todaydate#.txt" 
								output="CC: #LBfullname#, #LBemail#, Division: #division_name#">
						        <cffile action="Append" 
			...
			<!--- MJ --->
							...
							<cfset fullname= #Trim(dsMJData.cFullName)#>
							<cfset firstname = listgetat(fullname,2)>
							<cfset lastname  = listgetat(fullname,1)>
							<cfset dsEmailList = helperObj.qryHouseVisitIIRegionList(2)>
							<cfset division_name = dsemailList.division_name>
						<cfmail to="#dsMJData.cemail#"    CC="#KBemail#, #LBemail#"	from="report@alcco.com" subject="House Visit Report #division_name# Division">				  	
							Attached is the weekly House Visit Report for #division_name# Division.
							<cfloop query="dsEmailList" >
								<cfset regionfilename = replace(replace(dsEmailList.regionname, " " , "_","All"),"/", "_","All")>
								<cfif FileExists("\\fs01\ALC_IT\HouseVisit\Region\reg_#regionfilename#_housevisit.xls") is "yes">
