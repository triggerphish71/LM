...
<cfset dsAnswers = helperObj.FetchHouseVisitAnswersIIALL4(1)>
<cfset dsRegionId = helperObj.qryDashboardRegionA(1)>	
<cfloop query="dsRegionId">
	...
	<cfcatch type="any">
		<cfmail to="sfarmer@alcco.com" from="FTA_HouseVisit_Region_XLS.cfm@alcco.com" subject="House Visit Region Div 1 XLS failed" type="html">
