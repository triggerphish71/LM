<!--- HouseVisitIIRegionXLS.cfm extracts house visit reports placing each region in a file and each house within that region in a tab. --->
...
<cfset dsAnswers = helperObj.FetchHouseVisitAnswersIIALL4(11)>
<cfset dsRegionId = helperObj.qryDashboardRegionA(11)>	
<cfloop query="dsRegionId">
					...
					<Worksheet ss:Name="#thishousename#">			 	 
						...
						<Table>
							...
							<Row ss:AutoFitHeight="0" ss:Height="38.25" >
								<Cell ss:StyleID="s2">
									<Data ss:Type="String">House Visits Region: #XmlFormat(Trim(thisregionname))#  Thru Date: #XmlFormat(Trim(thisThruDateF))#</Data>
								</Cell>
							...
							<cfloop query="dsGroups" > 
								...
								<cfloop query="dsGroupQuestionsHdr">
									...
									<cfif hdrSize lte 3>
										...
										<cfset dsEntryAnswers = helperObj.FetchHouseVisitAnswersIIA(#thisentryid#, #thisgroup#,#thisquestion#, #dsAnswers#)> 
										<cfset j = 0>
	...
	<cfcatch type="any">
		<cfmail to="sfarmer@alcco.com" from="FTA_HouseVisit_Region_XLS.cfm@alcco.com" subject="House Visit Region Div 11 XLS failed" type="html">
