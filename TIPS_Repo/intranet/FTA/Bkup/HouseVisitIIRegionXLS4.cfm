...
<cfset dsAnswers = helperObj.FetchHouseVisitAnswersIIALL4(4)>
<cfset dsRegionId = helperObj.qryDashboardRegionA(4)>	
<cfloop query="dsRegionId">
	...
	<cfcatch type="any">
		<cfmail to="sfarmer@alcco.com" from="FTA_HouseVisit_Region_XLS.cfm@alcco.com" subject="House Visit Region Div 4 XLS failed" type="html">
