		...
		<head>
			...
			<script language="javascript" type="text/javascript">
				...
				function save()
				{
					...
					document.frmEditHouseVisitEntry.action = "EditHouseVisitEntry.cfm?Save=Yes&EntryId=#entryId#&iHouse_ID=#houseId#&SubAccount=#subAccount#&DateToUse=#dateToUse#";
					// Exicute the Form's Submit() action.
					document.frmEditHouseVisitEntry.submit();
...
<cfoutput>
	...
	<table id="tblEditEntry" cellspacing="0" cellpadding="1" border="1px" width="880px">
		<tr>
		...
		<cfloop query="dsGroups">
			...
			<cfloop query="dsGroupQuestions">
				...
				<tr>
						...
						<table width="100%" height="100%" border="0px" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td style="width: 30px;" valign="top" align=" right" bgcolor="#freezeColor#">
									<!--- Define the spell check image button's attributes. --->
					...
					<td align="left" bgcolor="#freezeColor#" valign="top" style="width: 400px;">
						<div id="divAnswer_#dsGroupQuestions.iQuestionId#" style="height: 100%; width: 400px;">
							<cfif spellCheckingActive eq true>
							...
							<cfset textAreaOutput = "<TextArea onKeyDown='addUnloadPrompt(#dsGroupQuestions.iQuestionId#);' onChange='addUnloadPrompt(#dsGroupQuestions.iQuestionId#);' name='txtAnswer_#dsGroupQuestions.iQuestionId#' id='txtAnswer_#dsGroupQuestions.iQuestionId#' style='height: 100%; width: 400px; font-family: verdana; overflow-x: hidden; overflow-y: scroll; #displayTextBox#'>#textAreaValue#</TextArea>">
							#textAreaOutput#
							<cfif spellCheckCurrentItem eq true And currentSpellCheckItem.IsCorrect eq false>
