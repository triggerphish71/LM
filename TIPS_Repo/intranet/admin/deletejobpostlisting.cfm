...
<tr bgcolor="#663300">
    <td colspan="7">
	<font color="White" style="font-family: Verdana, Geneva, Arial, Helvetica, sans-serif; font-size: medium;">Delete Job Posting</font>
	</td>
</tr>
<tr>
...
<cfoutput query="getlisting">
	...
	<td align="center"><A HREF="deletejobposting.cfm?index=#Form_Ndx#&region=#url.region#"><img src="../pix/view.gif" width="23" height="22" alt="" border="0"></A></td>
...
<cfelse>
<tr bgcolor="#f7f7f7">
	<td colspan="7"><BR><ul><font style="font-family: Verdana, Geneva, Arial, Helvetica, sans-serif; font-size: x-small; font-weight: bold;">There are no positions to delete.</font></ul></td>
</tr>
<tr bgcolor="#eaeaea">
	<td colspan="7"><input type="button" name="back" value="Back" onClick="history.back();"></td>
</tr>
