...
<form method="post" action="editfilelisting.cfm" name="resourcerec">
  <ul>
    <table width="435" border="0" cellspacing="1" cellpadding="2">
      <tr> 
        <td colspan="3" bgcolor="#006699"><font face="Arial, Helvetica, sans-serif" color="White" style="font-family: Verdana, Geneva, Arial, Helvetica, sans-serif; font-size: medium;">&nbsp;Locate Media to Edit</font></td>
      </tr>
      <tr bgcolor="#eaeaea"> 
        <td colspan="2"><font face="Arial, Helvetica, sans-serif" size="2"><b>Find 
          By Location</font></b></td>
        <td width="215">&nbsp;</td>
      </tr>
      <tr bgcolor="#eaeaea"> 
        <td width="14"> 
	  ...
	  <!--- comment: this is being removed because there is no operations section and there is no need for a 'home' designation when ALC home office is in Regions--->
     <!---  <tr bgcolor="#eaeaea"> 
        <td width="14"> 
          &nbsp;
        </td>
      ...
      <tr bgcolor="#CCCCCC"> 
        ...
        <td width="215"><A href="javascript:calendar(2)"><img src="../../pix/calendaricon.gif" width="19" height="20" alt="" border="0"></A>&nbsp; 
  ...
  <!---     <tr bgcolor="#999999"> 
   ...
   <input type="hidden" name="searchtype_required" value="One of the 'Location' radio buttons needs to be selected.">
</form>
</body>
</html>
