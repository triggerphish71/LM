   ...
   <!---    <tr bgcolor="#f7f7f7"> 
      ...
      <tr bgcolor="#f7f7f7"> 
	   ...
	   <tr bgcolor="#f7f7f7"> 
        <td width="16">&nbsp;</td>
        <td width="89">&nbsp;</td>
        <td colspan="2" valign="middle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><font size="2" face="Arial, Helvetica, sans-serif">Associate File:</font>&nbsp;&nbsp;<input type="text" name="childname" readonly>&nbsp;<input type="button" name="assign" value="Select File" onClick="getcatid();">
      ...
      <tr bgcolor="#eaeaea"> 
        ...
        <td colspan="2" width="441"> 
          <input type="file" name="docfile" size="75" accept="application/vnd.ms-excel,application/msword,application/pdf,image/jpeg,image/GIF,video/quicktime,application/x-msexcel,image/pjpeg">
        </td>
      </tr>
	   <tr bgcolor="#eaeaea"> 
