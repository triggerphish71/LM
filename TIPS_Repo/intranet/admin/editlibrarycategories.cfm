...
<cfif url.page is 0>
	...
	<ul>
	<form action="editlibrarycategories.cfm?page=1" method="post">
	<table width="490" border="0" cellspacing="0" cellpadding="2">
	  <tr bgcolor="#006699"> 
	    <td colspan="4"><font color="White" style="font-family: Verdana, Geneva, Arial, Helvetica, sans-serif; font-size: medium;">&nbsp;Edit 
...
<!--- comment: Next page--->
	...
	<table width="600" border="0" cellspacing="0" cellpadding="2">
	  ...
	  <tr bgcolor="#eaeaea"> 
		...
		<!--- will re-implement Topics when there is more time --->
